...
The Composable Kernel library consists of four layers: a templated tile operator layer, a templated kernel and invoker layer, an instantiated kernel and invoker layer, and a client API layer.

...
Here's a complete example showing how all components work together in a :ref:`matrix multiplication kernel <ck_tile_gemm_optimization>`:
...
With an understanding of TileWindow, explore:

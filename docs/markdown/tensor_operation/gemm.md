...
* **ALayout** - A layout (RowMajor/ColumnMajor).
...
* **DeviceGemm_Xdl_CShuffle_LdsDirectLoad** - Device operation with XDL instructions with CShuffle optimization for more optimized data store and direct load from global memory to shared memory.

...
using KernelTypesCompV3 = ::testing::Types<
     ...
     std::tuple<    Row,     Row,     Row,       I8,       I8,          I32,       I32,             Intrawave,         CompV3,        std::false_type,      std::false_type>, 
     std::tuple<    Row,     Col,     Row,       I8,       I8,          I32,       I32,             Intrawave,         CompV3,        std::false_type,      std::false_type>,
     std::tuple<    Col,     Row,     Row,       I8,       I8,          I32,       I32,             Intrawave,         CompV3,        std::false_type,      std::false_type>, 
     std::tuple<    Col,     Col,     Row,       I8,       I8,          I32,       I32,             Intrawave,         CompV3,        std::false_type,      std::false_type>

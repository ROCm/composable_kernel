...
__global__ void MyKernel(Args... args) { Kernel{}(args...); }
...
CK_TILE_HOST void test_convert() {
	...
	const auto ref_data = std::array{
		0.f, 0.f, 0.5f, 1.f, 1.f, 1.f, 1.5f, 2.f,
		-0.f, -0.f, -0.5f, -1.f, -1.f, -1.f, -1.5f, -2.f,
		2.f, 2.f, 3.f, 4.f, 4.f, 4.f, 6.f, 6.f};
    ...
    if constexpr (is_device) {
        ...
        MyKernel<job><<<1, 1>>> (
            reinterpret_cast<const SRC*>(in_d -> GetDeviceBuffer()), 

...
using KernelTypes_BQuant = ::testing::Types<
    ...
    // Base instances: RCR FP8/BF16 persistent (with/without PreShuffleB)
    ...
    // Non-persistent variants (with/without PreshuffleB)
    ...
    // Alternative layouts: RRR, CRR, CCR (without PreshuffleB)

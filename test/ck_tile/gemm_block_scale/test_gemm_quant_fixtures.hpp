...
template <typename DataType>
struct GemmConfigPrefillIntrawave : public GemmConfigBase<DataType>
{
    static constexpr ck_tile::index_t M_Tile = 128;
    static constexpr ck_tile::index_t N_Tile = 128;
    static constexpr ck_tile::index_t K_Tile = 128;
...
template <typename DataType>
struct GemmConfigPrefillInterwave : public GemmConfigBase<DataType>
{
    static constexpr ck_tile::index_t M_Tile = 128;
    static constexpr ck_tile::index_t N_Tile = 128;
    static constexpr ck_tile::index_t K_Tile = 128;
...
template <typename DataType>
struct GemmConfigDecodeIntrawave : public GemmConfigBase<DataType>
{
    static constexpr ck_tile::index_t M_Tile = 16;
    static constexpr ck_tile::index_t N_Tile = 64;
    static constexpr ck_tile::index_t K_Tile = 256;
...
template <typename DataType>
struct GemmConfigDecodeInterwave : public GemmConfigBase<DataType>
{
    static constexpr ck_tile::index_t M_Tile = 16;
    static constexpr ck_tile::index_t N_Tile = 64;
    static constexpr ck_tile::index_t K_Tile = 256;

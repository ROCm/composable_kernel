...
using ABQuantPreshuffleBTypes = ::testing::Types<
    ...
    std::tuple<RowMajor, ColumnMajor, RowMajor, RowMajor, FP8, FP8, float, Half, ABQuantGrouped, GemmConfigPreshuffleBPrefill<FP8>, GroupSize, GroupSize, ColumnMajor>,
    std::tuple<RowMajor, ColumnMajor, RowMajor, RowMajor, FP8, FP8, float, Half, ABQuantGrouped, GemmConfigPreshuffleBPrefill<FP8>, GroupSize, GroupSize2D128N, ColumnMajor>
>;
// clang-format on

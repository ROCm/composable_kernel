...
using BQuantTypes = ::testing::Types<
    ...
    // some cases with different layouts
    std::tuple<   RowMajor,    RowMajor, RowMajor, FP8, FP8,    float, Half, BQuantGrouped, GemmConfigBase, GroupSize64>,
    std::tuple<ColumnMajor, ColumnMajor, RowMajor, FP8, FP8,    float, Half, BQuantGrouped, GemmConfigBase, GroupSize64>,
    std::tuple<ColumnMajor,    RowMajor, RowMajor, FP8, FP8,    float, Half, BQuantGrouped, GemmConfigBase, GroupSize64>,
    std::tuple<   RowMajor,    RowMajor, RowMajor, FP8, FP8,    float, Half, BQuantGrouped, GemmConfigBase, GroupSize2D64N>,
    std::tuple<ColumnMajor, ColumnMajor, RowMajor, FP8, FP8,    float, Half, BQuantGrouped, GemmConfigBase, GroupSize2D64N>,
    std::tuple<ColumnMajor,    RowMajor, RowMajor, FP8, FP8,    float, Half, BQuantGrouped, GemmConfigBase, GroupSize2D64N>
    // std::tuple<   RowMajor,    RowMajor, RowMajor, FP8, PkInt4, float, Half, BQuantGrouped, GemmConfigBase, GroupSize64>,
    // std::tuple<ColumnMajor, ColumnMajor, RowMajor, FP8, PkInt4, float, Half, BQuantGrouped, GemmConfigBase, GroupSize64>,
    // std::tuple<ColumnMajor,    RowMajor, RowMajor, FP8, PkInt4, float, Half, BQuantGrouped, GemmConfigBase, GroupSize64>,
    // std::tuple<   RowMajor,    RowMajor, RowMajor, FP8, PkInt4, float, Half, BQuantGrouped, GemmConfigBase, GroupSize2D64N>,
    // std::tuple<ColumnMajor, ColumnMajor, RowMajor, FP8, PkInt4, float, Half, BQuantGrouped, GemmConfigBase, GroupSize2D64N>,
    // std::tuple<ColumnMajor,    RowMajor, RowMajor, FP8, PkInt4, float, Half, BQuantGrouped, GemmConfigBase, GroupSize2D64N>
>;
// clang-format on

...
template <typename Tuple>
class TestSoftmaxFP16Reduce1DInnerDims : public ck::TestSoftmax<Tuple>
{
};
...
template <typename Tuple>
class TestSoftmaxFP16Reduce2DInnerDims : public ck::TestSoftmax<Tuple>
{
};
...
// InDataType, AccDataType, OutDataType, Rank, NumReduceDim, BlockSize, MThreadClusterSize, KThreadClusterSize, MThreadSliceSize, KThreadSliceSize, InSrcVectorDim, InSrcVectorSize, OutDstVectorSize>
    std::tuple<ck::half_t, float, ck::half_t, I<3>, I<1>, I<256>, I<2>, I<128>, I<1>, I<8>, I<1>, I<1>, I<1>>,   // fallback
    std::tuple<ck::half_t, float, ck::half_t, I<3>, I<1>, I<256>, I<8>, I<32>, I<8>, I<4>, I<0>, I<8>, I<4>>
    >;
...
// InDataType, AccDataType, OutDataType, Rank, NumReduceDim, BlockSize, MThreadClusterSize, KThreadClusterSize, MThreadSliceSize, KThreadSliceSize, InSrcVectorDim, InSrcVectorSize, OutDstVectorSize>
    std::tuple<ck::half_t, float, ck::half_t, I<3>, I<2>, I<256>, I<2>, I<128>, I<1>, I<8>, I<1>, I<1>, I<1>>,   // fallback
    std::tuple<ck::half_t, float, ck::half_t, I<3>, I<2>, I<256>, I<8>, I<32>, I<8>, I<4>, I<0>, I<8>, I<4>>
    >;
...
TYPED_TEST_SUITE(TestSoftmaxFP16Reduce1DInnerDims, KernelTypesReduce1DInnerDims);
TYPED_TEST_SUITE(TestSoftmaxFP16Reduce2Dims, KernelTypesReduce2Dims);
TYPED_TEST_SUITE(TestSoftmaxFP16Reduce2DInnerDims, KernelTypesReduce2DInnerDims);
...
TYPED_TEST(TestSoftmaxFP16Reduce1Dim, IncorrectReduceDims)
{
...
TYPED_TEST(TestSoftmaxFP16Reduce1DInnerDims, ReduceInnerDims)
{
    std::vector<ck::index_t> reduce_dims{1};
    this->Run(reduce_dims);
...
TYPED_TEST(TestSoftmaxFP16Reduce2Dims, ReduceIncorrectDims)
{
...
TYPED_TEST(TestSoftmaxFP16Reduce2DInnerDims, ReduceInnerDims)
{

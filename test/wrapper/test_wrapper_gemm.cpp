                                                        ...
                                                        const ThreadLayout thread_layout)
{
    ...
    auto a_padded_unmerged_global_layout = ck::wrapper::unmerge<1>(
        a_padded_global_layout, ck::make_tuple(K0PerBlock, K1), reshaped_dims_idxs);
    auto b_padded_unmerged_global_layout = ck::wrapper::unmerge<1>(
        b_padded_global_layout, ck::make_tuple(K0PerBlock, K1), reshaped_dims_idxs);

...
* Added support GKCYX layout for grouped convolution backward data (NGCHW/GKCYX/NGKHW, number of instances in instance factory for NGCHW/GKYXC/NGKHW has been reduced).

...
def ck_gemm(A: torch.Tensor, B: torch.Tensor, 
            transpose_a: bool = False, transpose_b: bool = False) -> torch.Tensor:
    """
...
def ck_linear(input: torch.Tensor, weight: torch.Tensor, 
...
def benchmark_vs_pytorch(M: int = 1024, N: int = 1024, K: int = 1024,

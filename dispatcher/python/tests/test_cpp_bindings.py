...
class TestProblem:
    ...
    def test_problem_attributes(self):
        ...
        assert problem.prefer_persistent == False
        assert problem.enable_validation == False
...
class TestIntegration:
    ...
    def test_problem_creation_workflow(self):
        ...
        assert problem3.prefer_persistent == True
        assert problem3.enable_validation == True

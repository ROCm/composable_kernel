...
TEST_F(DataTypeTest, AllDataTypesExist) {
    ...
    std::vector<DataType> all_types = {
        ...
        DataType::INT8, DataType::INT4, DataType::INT32,
        DataType::FP8, DataType::BF8, DataType::UNKNOWN
    };
...
TEST_F(LayoutTagTest, LayoutsAreDifferent) {
    EXPECT_NE(LayoutTag::RowMajor, LayoutTag::ColMajor);
}
...
TEST_F(PipelineTest, AllPipelinesExist) {
    std::vector<Pipeline> all_pipelines = {
        Pipeline::Mem, Pipeline::CompV1, Pipeline::CompV2,
        Pipeline::CompV3, Pipeline::CompV4, Pipeline::CompV5,
        Pipeline::PreShuffleV1, Pipeline::PreShuffleV2
    };
...
TEST_F(EpilogueTest, AllEpiloguesExist) {
    std::vector<Epilogue> all_epilogues = {
        Epilogue::None, Epilogue::Default, Epilogue::CShuffle,
        Epilogue::Bias, Epilogue::Activation, Epilogue::BiasActivation
    };
...
TEST_F(SignatureTest, AllLayoutCombinations) {
    std::vector<std::string> layout_codes = {"rrr", "rcr", "crr", "ccr", "rrc", "rcc", "crc", "ccc"};
...
TEST_F(AlgorithmTest, AllPipelines) {
    ...
    std::vector<Pipeline> pipelines = {
        Pipeline::Mem, Pipeline::CompV3, Pipeline::CompV4,
        Pipeline::PreShuffleV1, Pipeline::PreShuffleV2
    };

 ...
 * Generated at: 2025-12-05T18:26:14.221845
 * 
 * To update this file:
...
inline GpuArch string_to_arch(const std::string& arch_str) {
    if (arch_str == "gfx908") return GpuArch::GFX_908;
    ...
    if (arch_str == "gfx1100") return GpuArch::GFX_1100;
    if (arch_str == "gfx1200") return GpuArch::GFX_1200;

...
int main(int argc, char** argv)
{
    ...
    // Copy result back
    HIP_CHECK(hipMemcpy(c_m_n_gpu_result.data(), c_dev, M * N * sizeof(CDataType), hipMemcpyDeviceToHost));
    ...
    const float max_accumulated_value = *std::max_element(
        c_m_n_cpu_reference.mData.begin(), c_m_n_cpu_reference.mData.end());

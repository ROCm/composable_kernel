...
def benchmark_size(
    lib, M: int, N: int, K: int, warmup_runs: int = 3, bench_runs: int = 10
) -> BenchmarkResult:
    ...
    return BenchmarkResult(
        M, N, K, min_ms, max_ms, avg_ms, median_ms, tflops, bandwidth_gb
    )
...
def print_results(results: List[BenchmarkResult]):
    ...
    print()
    print(
        f"{'Size':>20} {'Min (ms)':>12} {'Avg (ms)':>12} {'Med (ms)':>12} {'Max (ms)':>12} {'TFLOPS':>12} {'BW (GB/s)':>12}"
    )
    print("-" * 92)
    ...
    for r in results:
        ...
        print(
            f"{size_str:>20} {r.min_ms:>12.4f} {r.avg_ms:>12.4f} {r.median_ms:>12.4f} {r.max_ms:>12.4f} {r.tflops:>12.2f} {r.bandwidth_gb:>12.2f}"
        )

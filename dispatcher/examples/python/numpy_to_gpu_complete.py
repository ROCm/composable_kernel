...
def main():
    ...
    try:
        ...
        print(f"OK GPU execution complete!")
    ...
    if accuracy > 99.9:
        ...
        print(f"  Status: [FAIL] Accuracy too low")
    print()
    ...
    print(f"GPU vs NumPy comparison:")
    print(f"  Max difference: {max_diff:.6f}")
    print(f"  Mean difference: {mean_diff:.6f}")
    
    if max_diff < 0.01:
        print(f"  Status: [OK] Perfect match!")
    else:
    ...
    print()
    print("Achieved:")
    print(f"  [OK] Started with NumPy matrices in Python")
    print(f"  [OK] Compiled dynamic library with dispatcher")
    print(f"  [OK] Loaded .so back into Python via ctypes")
    print(f"  [OK] Passed NumPy pointers to C++")
    print(f"  [OK] C++ executed GPU GEMM via dispatcher: {tflops:.2f} TFLOPS")
    print(f"  [OK] Results written back to NumPy arrays")

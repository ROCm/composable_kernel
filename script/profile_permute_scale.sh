...
# 1D
########  op  datatype  verify  init  log  time  dims     in_strides out_strides
#  $DRIVER $OP $DATATYPE $VERIFY $INIT $LOG $TIME  67108864 1          2
#  $DRIVER $OP $DATATYPE $VERIFY $INIT $LOG $TIME  67108864 2          1

# # 2D
# ########  op  datatype  verify  init  log  time  dims      in_strides out_strides
#  $DRIVER $OP $DATATYPE $VERIFY $INIT $LOG $TIME  8192 8192 8192 1     1 8192
#  $DRIVER $OP $DATATYPE $VERIFY $INIT $LOG $TIME  8192 8192 1 8192     8192 1
...
# ./bin/ckProfiler permute_scale 1 0 1 0 1 8 2 512 8192  0 1 2 3                  3 2 1 0

...
def parse_args():
    ...
    parser.add_argument('-f', required=True, help="Path to enhanced_dependency_mapping.json file generated by dependency parser")
...
def main():
    ...
    for v in file_to_executables:
        if "composablekernel/include/" in v or "composablekernel/library/" in v or "composablekernel/profiler/" in v:

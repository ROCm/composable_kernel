...
# class GemmUniversalKernelBuilder(BaseGemmKernelBuilder):
#     def _get_kernel_prefix(self):
#         return "gemm"

#     def _get_pipeline_maps(self):
#         # Return regular GEMM pipeline maps

#     def _generate_kernel_instance(self, tile_config, trait_combo, k_block_per_cu, is_header=True):
#         # Regular GEMM kernel generation logic

#     def _get_file_names(self):
#         return "gemm_kernel_count.txt", "gemm_kernel_list.txt"

#     def _get_cmake_function_name(self):
#         return "create_individual_gemm_target"

#     def _validate_layout_constraints(self, layout_parts):
#         # Allow rcr, rrr, ccr, crr layouts

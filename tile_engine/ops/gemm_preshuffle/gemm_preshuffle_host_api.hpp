...
#include "gemm_preshuffle_dispatcher.hpp"
...
inline auto create_args(int argc, char* argv[])
{
    ...
    arg_parser.insert("m", "3840", "The value for m dimension. Default is 3840.")
        ...
        .insert("csv_filename",
                "gemm_preshuffle_kernel",
                "The filename of benchmark result. Default is gemm_preshuffle_kernel.")
...
auto get_kernel_func_by_trait(const ck_tile::ArgParser& arg_parser)
{
    ...
    return GemmPreshuffleDispatcher::dispatch(structured_sparsity, trait);
}

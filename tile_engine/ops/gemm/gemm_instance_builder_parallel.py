...
// Tile configuration
constexpr ck_tile::index_t BlockSize = 256;
constexpr ck_tile::index_t TileM = {tile_config["tile_m"]};
constexpr ck_tile::index_t TileN = {tile_config["tile_n"]};
constexpr ck_tile::index_t TileK = {tile_config["tile_k"]};
constexpr ck_tile::index_t WarpPerBlock_M = {tile_config["warp_m"]};
constexpr ck_tile::index_t WarpPerBlock_N = {tile_config["warp_n"]};
constexpr ck_tile::index_t WarpPerBlock_K = {tile_config["warp_k"]};
constexpr ck_tile::index_t WarpTileM = {tile_config["warp_tile_m"]};
constexpr ck_tile::index_t WarpTileN = {tile_config["warp_tile_n"]};
constexpr ck_tile::index_t WarpTileK = {tile_config["warp_tile_k"]};
...
struct SelectedKernel {{
    static float launch(const ck_tile::GemmHostArgs& args, const ck_tile::stream_config& stream) {{
        ...
        // Pipeline problem
        using GemmPipelineProblem = ck_tile::UniversalGemmPipelineProblem<
            ADataType,
            BDataType,
            AccDataType,
            TileShape,
            Traits,
            {scheduler_type_map.get(scheduler, "ck_tile::GemmPipelineScheduler::Intrawave")},
            {"true" if pipeline in ["compv3", "compv4"] else "false"},  // HasHotLoop

...
#include "grouped_gemm_tensorquant_profiler.hpp"
...
// DataTypeTraits are now defined in grouped_gemm_tensorquant_common.hpp
...
void benchmark_single(const ck_tile::ArgParser& arg_parser)
{
    ...
    // Create GroupedTensorQuantGemmProblem struct
    GroupedTensorQuantGemmProblem problem{group_count,
                                          kbatch,
                                          Ms,
                                          Ns,
                                          Ks,
    ...
    auto& profiler = GroupedTensorQuantGemmProfiler::instance(settings);

...
namespace compv4_cshuffle_intrawave_false_false_false {
...
struct GemmKernel {
    ...
    static float launch(ck_tile::GemmHostArgs<>& args, const ck_tile::stream_config& stream) {
        ...
        using BaseGemmPipeline = ck_tile::BaseGemmPipelineAgBgCrCompV4<GemmPipelineProblem>;
        ...
        const auto Run = [&](const auto has_hot_loop_, const auto tail_number_, const auto memory_operation_) {
            ...
            using GemmPipeline = ck_tile::GemmPipelineAgBgCrCompV4<UniversalGemmProblem>;

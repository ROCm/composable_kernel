...
using device_gemm_xdl_instance_f32_f32_f32_mk_kn_mn = std::tuple<
    // clang-format off
        ...
        //#################|      |      |      |        |        |        |        |      |      |      |      |   |     |     |     |     |                |                |               |               |               |               |               |                |                |               |               |              |               |               |                |                |          |          |
        DeviceGemmSplitKXdl<  F32,   F32,   F32,     F32,     Row,     Row,     Row,   256,   256,   128,     4,  4,   32,   32,    4,    2,      S<1, 1, 4, 4>,     S<1, 4, 64, 1>,     S<0, 2, 1, 3>,     S<0, 2, 1, 3>,              3,              4,              4,      S<1, 1, 2, 4>,     S<1, 4, 64, 1>,     S<0, 1, 3, 2>,     S<0, 1, 3, 2>,             2,              2,              4,               7,               1,      true,      true, 360>,
        DeviceGemmSplitKXdl<  F32,   F32,   F32,     F32,     Row,     Row,     Row,   256,   128,   256,     4,  4,   32,   32,    2,    4,      S<1, 1, 2, 4>,     S<1, 4, 64, 1>,     S<0, 2, 1, 3>,     S<0, 2, 1, 3>,              3,              4,              4,      S<1, 1, 4, 4>,     S<1, 4, 64, 1>,     S<0, 1, 3, 2>,     S<0, 1, 3, 2>,             2,              4,              4,               7,               1,      true,      true, 360>,
        DeviceGemmSplitKXdl<  F32,   F32,   F32,     F32,     Row,     Row,     Row,   128,   128,   128,     4,  4,   32,   32,    4,    2,      S<1, 1, 4, 4>,     S<1, 4, 32, 1>,     S<0, 2, 1, 3>,     S<0, 2, 1, 3>,              3,              4,              4,      S<1, 1, 4, 4>,     S<1, 4, 32, 1>,     S<0, 1, 3, 2>,     S<0, 1, 3, 2>,             2,              4,              4,               7,               1,      true,      true, 360>,
        ...
        DeviceGemmSplitKXdl<  F32,   F32,   F32,     F32,     Row,     Row,     Row,   128,   128,    64,     4,  4,   32,   32,    2,    2,      S<1, 1, 4, 4>,     S<1, 4, 32, 1>,     S<0, 2, 1, 3>,     S<0, 2, 1, 3>,              3,              4,              4,      S<1, 1, 2, 4>,     S<1, 4, 32, 1>,     S<0, 1, 3, 2>,     S<0, 1, 3, 2>,             2,              2,              4,               7,               1,      true,      true, 360>,
        DeviceGemmSplitKXdl<  F32,   F32,   F32,     F32,     Row,     Row,     Row,   128,    64,   128,     4,  4,   32,   32,    2,    2,      S<1, 1, 2, 4>,     S<1, 4, 32, 1>,     S<0, 2, 1, 3>,     S<0, 2, 1, 3>,              3,              4,              4,      S<1, 1, 4, 4>,     S<1, 4, 32, 1>,     S<0, 1, 3, 2>,     S<0, 1, 3, 2>,             2,              4,              4,               7,               1,      true,      true, 360>,
        DeviceGemmSplitKXdl<  F32,   F32,   F32,     F32,     Row,     Row,     Row,   256,   128,    64,     4,  4,   32,   32,    2,    1,      S<1, 1, 2, 4>,     S<1, 4, 64, 1>,     S<0, 2, 1, 3>,     S<0, 2, 1, 3>,              3,              4,              4,      S<1, 1, 1, 4>,     S<1, 4, 64, 1>,     S<0, 1, 3, 2>,     S<0, 1, 3, 2>,             2,              1,              4,               7,               1,      true,      true, 360>,
        DeviceGemmSplitKXdl<  F32,   F32,   F32,     F32,     Row,     Row,     Row,   256,    64,   128,     4,  4,   32,   32,    1,    2,      S<1, 1, 1, 4>,     S<1, 4, 64, 1>,     S<0, 2, 1, 3>,     S<0, 2, 1, 3>,              3,              4,              4,      S<1, 1, 2, 4>,     S<1, 4, 64, 1>,     S<0, 1, 3, 2>,     S<0, 1, 3, 2>,             2,              2,              4,               7,               1,      true,      true, 360>
    >;
#else
using device_gemm_xdl_instance_f32_f32_f32_mk_kn_mn = std::tuple<
    // clang-format off

...
ADD_INST_BY_ID(threadwise, half_t, half_t, half_t, 2, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, half_t, half_t, half_t, 3, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, half_t, half_t, half_t, 4, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, half_t, half_t, half_t, 2, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, half_t, half_t, half_t, 3, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, half_t, half_t, half_t, 4, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, half_t, float, half_t, 0, 0, 0, 2, 1);
...
ADD_INST_BY_ID(threadwise, half_t, float, half_t, 1, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, half_t, float, half_t, 5, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, half_t, float, half_t, 6, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, float, double, float, 6, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(threadwise, float, double, float, 7, 0, 0, 2, 1);       //

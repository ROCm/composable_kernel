...
#define ADD_BLOCKWISE_INST_BY_TYPE(inT, compT, outT, reduceOp, nanOpt, indicesOpt, rank, ...) \
...
#define ADD_BLOCKWISE_INST_BY_ID(inT, compT, outT, reduceOp, nanOpt, indicesOpt, rank, ...) \

...
ADD_INST_BY_ID(multiblock_two_call, half_t, half_t, half_t, 2, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, half_t, half_t, half_t, 3, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, half_t, half_t, half_t, 4, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, half_t, half_t, half_t, 2, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, half_t, half_t, half_t, 3, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, half_t, half_t, half_t, 4, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, float, float, float, 2, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, float, float, float, 3, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, float, float, float, 4, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, float, float, float, 2, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, float, float, float, 3, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, float, float, float, 4, 0, 1, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, half_t, float, float, 7, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, float, float, float, 7, 0, 0, 2, 1);       //
...
ADD_INST_BY_ID(multiblock_two_call, float, double, float, 7, 0, 0, 2, 1);       //

...
struct DeviceReduceMultiBlockAtomicAdd : public DeviceReduce<inType, compType, outType, rank, reduceDims, reduceOp, nanOpt, indicesOpt>
{
     ...
     static const auto MakeSrc2dDescriptr(std::vector<int> & inLengths, std::vector<int> & inStrides, size_t gridSize, int blkGroupSize)
     {
     ...
     struct Invoker : public BaseInvoker
     {
	     ...
	     const auto kernel_main = kernel_reduce_multiblock_atocmi_add<gridwise_reduce, inType, outType, src2dDescType, dst1dDescType>;
             ...
             ave_time_pre = launch_and_time_kerne(kernel_pre, nrepeat, 
             ...
             ave_time_main = launch_and_time_kernel(kernel_main, nrepeat,
                                                  dim3(arg.gridSize),
                                                  dim3(blockSize),
                                                  0,
                                                  src2dDesc,
             ...
             return(ave_time_pre+ave_time_main);
         };

...
ADD_INST_REF_BY_ID(blockwise, half_t, float, half_t, 1, 0, 0, 4, 0, 1, 2); // for MUL
ADD_INST_REF_BY_ID(blockwise, half_t, float, half_t, 1, 0, 0, 4, 0);       //
ADD_INST_REF_BY_ID(blockwise, half_t, float, half_t, 1, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(blockwise, half_t, float, half_t, 6, 0, 0, 4, 0, 1, 2); // for NORM1
ADD_INST_REF_BY_ID(blockwise, half_t, float, half_t, 6, 0, 0, 4, 0);       //
ADD_INST_REF_BY_ID(blockwise, half_t, float, half_t, 6, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(blockwise, float, float, float, 1, 0, 0, 4, 0, 1, 2); // for MUL
ADD_INST_REF_BY_ID(blockwise, float, float, float, 1, 0, 0, 4, 0);       //
ADD_INST_REF_BY_ID(blockwise, float, float, float, 1, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(blockwise, float, float, float, 6, 0, 0, 4, 0, 1, 2); // for NORM1
ADD_INST_REF_BY_ID(blockwise, float, float, float, 6, 0, 0, 4, 0);       //
ADD_INST_REF_BY_ID(blockwise, float, float, float, 6, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(blockwise, float, double, float, 1, 0, 0, 4, 0, 1, 2); // for MUL
ADD_INST_REF_BY_ID(blockwise, float, double, float, 1, 0, 0, 4, 0);       //
ADD_INST_REF_BY_ID(blockwise, float, double, float, 1, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(blockwise, float, double, float, 6, 0, 0, 4, 0, 1, 2); // for NORM1
ADD_INST_REF_BY_ID(blockwise, float, double, float, 6, 0, 0, 4, 0);       //
ADD_INST_REF_BY_ID(blockwise, float, double, float, 6, 0, 0, 2, 1);       //

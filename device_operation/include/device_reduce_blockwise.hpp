...
struct DeviceReduceBlockWise : public DeviceReduce<inType, compType, outType, rank, toReduceDims, reduceOp, nanOpt, indicesOpt> 
{
     ...
     struct Invoker : public BaseInvoker
     {
         ...
         {
             const auto src2dDesc = DeviceReduceBlockWise::MakeSrc2dDescriptor(arg.inLengths_, arg.inStrides_, arg.gridSize);
             const auto dst1dDesc = DeviceReduceBlockWise::MakeDst1dDescriptor(arg.outLengths_, arg.outStrides_, arg.gridSize);

...
{
    static_assert(blockSize == dim0_thread_cluster_size * dim1_thread_cluster_size, "Invalid Configuration!");
...
template<int dim0_max_vector_size, int dim1_max_vector_size, int dim0_thread_slice_size, int dim1_thread_slice_size>

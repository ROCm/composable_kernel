...
template <int VectorDim, int VectorSize, int MThreadSliceSize, int KThreadSliceSize>
struct ReductionConfiguration_2
{
    static constexpr int VectorDim_        = VectorDim;
    static constexpr int VectorSize_       = VectorSize;
...
using reduce_configuration_2_instances = std::tuple<ReductionConfiguration_2<0, 2, 2, 1>,
                                                    ReductionConfiguration_2<1, 2, 1, 2>,

                                                    ReductionConfiguration_2<0, 1, 3, 1>,
                                                    ReductionConfiguration_2<1, 1, 1, 3>>;
#else
using reduce_configuration_2_instances = std::tuple<ReductionConfiguration_2<0, 4, 8, 1>,
                                                    ReductionConfiguration_2<0, 4, 4, 1>,
                                                    ReductionConfiguration_2<0, 2, 2, 1>,

                                                    ReductionConfiguration_2<1, 4, 1, 8>,
                                                    ReductionConfiguration_2<1, 4, 1, 4>,
                                                    ReductionConfiguration_2<1, 2, 1, 2>,

                                                    // special instances
                                                    ReductionConfiguration_2<0, 1, 3, 1>,
                                                    ReductionConfiguration_2<0, 1, 5, 1>,
                                                    ReductionConfiguration_2<0, 1, 7, 1>,
                                                    ReductionConfiguration_2<0, 1, 11, 1>,

                                                    ReductionConfiguration_2<0, 1, 1, 3>,
                                                    ReductionConfiguration_2<0, 1, 1, 5>,
                                                    ReductionConfiguration_2<0, 1, 1, 7>,
                                                    ReductionConfiguration_2<0, 1, 1, 11>>;
#endif

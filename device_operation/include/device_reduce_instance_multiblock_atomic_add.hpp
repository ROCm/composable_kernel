...
ADD_INST_REF_BY_ID(multiblock_atomic_add, half_t, float, float, 1, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(multiblock_atomic_add, half_t, float, float, 6, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(multiblock_atomic_add, float, float, float, 1, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(multiblock_atomic_add, float, float, float, 6, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(multiblock_atomic_add, float, double, float, 1, 0, 0, 2, 1);       //
...
ADD_INST_REF_BY_ID(multiblock_atomic_add, float, double, float, 6, 0, 0, 2, 1);       //

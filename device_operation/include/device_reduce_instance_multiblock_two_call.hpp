...
using reduce_configuration_2_instances_multiblock_two_call = std::tuple<
    // clang-format off
...
using deviceReduceMultiBlockTwoCallPtrType = DeviceReducePtr<
...
void add_device_reduce_instance_multiblock_two_call(
    std::vector<deviceReduceMultiBlockTwoCallPtrType<AccDataType, ReduceOpId>>& device_op_instances)
{
...
#define ADD_MULTIBLOCK_TWO_CALL_INST_BY_TYPE(                                           \
    ...
    template void add_device_reduce_instance_multiblock_two_call<inT,                   \
                                                                 ...
                                                                 NanOpt,                \
                                                                 IndicesOpt>(           \
        std::vector<deviceReduceMultiBlockTwoCallPtrType<compT, ReduceOpId>> &          \
        device_op_instances)

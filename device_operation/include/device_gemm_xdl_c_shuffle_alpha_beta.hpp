                                                                       ...
                                                                       CElementwiseOperation>
{
    ...
    {
        using Argument = DeviceGemmXdl_C_Shuffle_Alpha_Beta::Argument;
        ...
        float Run(const Argument& arg, int nrepeat = 1)
        {
            ...
            if(has_main_k0_block_loop)
            {
                const auto kernel = kernel_gemm_xdlops_v3r4<
                    ...
                    CDataType,
                    remove_reference_t<DeviceGemmXdl_C_Shuffle_Alpha_Beta::AGridDesc_K0_M_K1>,
                    remove_reference_t<DeviceGemmXdl_C_Shuffle_Alpha_Beta::BGridDesc_K0_N_K1>,
                    remove_reference_t<
                        typename GridwiseGemm::
                            CGridDescriptor_MBlock_MXdlPerWave_MWaveMPerXdl_NBlock_NXdlPerWave_NWaveNPerXdl>,
                    remove_reference_t<

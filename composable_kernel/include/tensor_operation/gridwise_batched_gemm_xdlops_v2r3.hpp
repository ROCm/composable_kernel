...
struct GridwiseBatchedGemm_sk0mk1_k0nk1_smn_xdlops_v2r3
{
    ...
    MakeAK0MK1GridDescriptor(const ASK0MK1GridDesc& a_s_k0_m_k1_grid_desc, const int s)
    {
        ...
        const auto a_k0_m_k1_grid_desc =
            transform_tensor_descriptor(a_s_k0_m_k1_grid_desc,
                                        make_tuple(make_freeze_transform(s),
                                                   make_pass_through_transform(K0),
                                                   make_pass_through_transform(M),
                                                   make_pass_through_transform(K1)),
                                        make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}, Sequence<3>{}),
...
__global__ void
    ...
    __launch_bounds__(CK_MAX_THREAD_PER_BLOCK, CK_MIN_BLOCK_PER_CU)
#endif
        kernel_batched_gemm_xdlops_v2r3_ver2(
            const FloatAB* __restrict__ p_a_grid,
            const FloatAB* __restrict__ p_b_grid,
            FloatC* __restrict__ p_c_grid,
            const index_t S,
...
template <index_t BlockSize,
          ...
          bool ABlockLdsExtraM,
          bool BBlockLdsExtraN>
struct GridwiseBatchedGemm_k0mk1_k0nk1_mn_xdlops_v2r3
{
    static constexpr auto I0 = Number<0>{};
    static constexpr auto I1 = Number<1>{};
    static constexpr auto I2 = Number<2>{};

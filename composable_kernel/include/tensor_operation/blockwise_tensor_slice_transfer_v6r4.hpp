#ifndef CK_BLOCKWISE_TENSOR_SLICE_TRANSFER_V6R4_HPP
#define CK_BLOCKWISE_TENSOR_SLICE_TRANSFER_V6R4_HPP

#include "common_header.hpp"
#include "tensor_descriptor.hpp"
#include "tensor_descriptor_helper.hpp"
#include "cluster_descriptor.hpp"
#include "threadwise_tensor_slice_transfer_v6r4.hpp"
...
struct BlockwiseTensorSliceTransfer_v6r4
{
    ...
    __device__ constexpr BlockwiseTensorSliceTransfer_v6r4(const Src0Desc& src0_desc,
                        ...
                        DstBuffer& dst_buf)
    {
           ...
           get_thread_local_1d_id() < thread_cluster_desc_.GetElementSize())
        {
            threadwise_transfer_.Run(
                src0_desc, src0_buf, src1_desc, src1_buf, alpha, beta, dst_desc, dst_buf);
            // threadwise_transfer_.Run(
            //     src0_desc, src0_buf, src1_desc, src1_buf, dst_desc, dst_buf);
        }
    }

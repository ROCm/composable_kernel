...
int main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        printf("arg4 to 10: M (256x), N(128x), K(32x), StrideA, StrideB, StrideD"
               "StrideE\n");
        exit(0);
    }
    ...
    Tensor<DDataType> d0_m_n(f_host_tensor_descriptor(M, N, StrideD, DLayout{}));
    ...
    case 1:
        ...
        d0_m_n.GenerateTensorValue(GeneratorTensor_2<DDataType>{-5, 5});
        break;
    default:
        a_m_k.GenerateTensorValue(GeneratorTensor_3<ADataType>{0.0, 1.0});
        b_k_n.GenerateTensorValue(GeneratorTensor_3<BDataType>{-0.5, 0.5});
        d0_m_n.GenerateTensorValue(GeneratorTensor_3<DDataType>{0.0, 1.0});
    }

    DeviceMem a_m_k_device_buf(sizeof(ADataType) * a_m_k.mDesc.GetElementSpace());
    DeviceMem b_k_n_device_buf(sizeof(BDataType) * b_k_n.mDesc.GetElementSpace());
    DeviceMem d0_m_n_device_buf(sizeof(DDataType) * d0_m_n.mDesc.GetElementSpace());
    ...
    if(do_verification)
    {
        ...
        for(int m = 0; m < M; ++m)
        {
            for(int n = 0; n < N; ++n)
            {
                cde_element_op(e_m_n_host_result(m, n), ck::type_convert<EDataType>(c_m_n(m, n)), d0_m_n(m, n));
            }
        }

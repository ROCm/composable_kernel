...
{
    constexpr ck::index_t split_k = 4;
...
bool run_conv_bwd_weight_example(int argc, char* argv[])
{
    ...
    {
    case 1: return run_conv_bwd_weight<1>(config, conv_param);
    case 2: return run_conv_bwd_weight<2>(config, conv_param);
    case 3: return run_conv_bwd_weight<3>(config, conv_param);
    }

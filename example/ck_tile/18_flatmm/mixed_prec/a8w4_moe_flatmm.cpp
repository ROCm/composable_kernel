...
float a8w4_moe_gemm(const MoeFlatmmHostArgs& args, const ck_tile::stream_config& s)
{
...
template <typename FlatmmConfig>
int run_a8w4_moe_flatmm_example(int argc, char* argv[])
{
    ...
    if(a_layout == "R" && b_layout == "C")
    {
        ...
        {
            if(mixed_prec == "fp8xfp4")
            {
                return run_a8w4_moe_gemm_example_with_layouts<
                    ck_tile::fp8_t,
                    ck_tile::pk_fp4_t,
                    FlatmmConfig,
        ...
        else if(gemm_kind == "gemm2")
        {
            if(mixed_prec == "fp8xfp4")
            {
                return run_a8w4_moe_gemm_example_with_layouts<ck_tile::fp8_t,
                                                              ck_tile::pk_fp4_t,
                                                              FlatmmConfig,
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if(warp_tile == 0)
        {
            return !run_a8w4_moe_flatmm_example<A8W4_FlatmmConfig16_950>(argc, argv);
        }
        // else if(warp_tile == 1)
        // {
        //     return !run_a8w4_moe_flatmm_example<A8W4_FlatmmConfig16_950>(argc, argv);

...
float flatmm_calc(const ck_tile::FlatmmHostArgs<>& args, const ck_tile::stream_config& s)
{
    ...
    using BaseGemmPipeline = ck_tile::BaseFlatmmPipelineAGmemBGmemCRegV1_1<GemmPipelineProblem>;
    ...
    const auto Run = [&](const auto has_hot_loop_,
        ...
        using CodegenFlatmmPipeline =
            ck_tile::FlatmmPipelineAGmemBGmemCRegV1_1<CodegenPipelineProblem>;

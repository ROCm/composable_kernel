    ...
    def get_blobs(self):
        ...
        h_trait_dicts = {
            0: {
                ...
                # '5120' :[ h_traits('x', 'y', 'xs', 'ys', 'uqy', 1,  5,  1, 256, 4,  True,  False, False,   False,   0,    0,    0),
                '5120' :[ h_traits('x', 'y', 'xs', 'ys', 'uqy', 1,  5,  1, 128, 8,  True,  False, False,   False,   0,    0,    0),
                          h_traits('x', 'y', 'xs', 'ys', 'uqy', 1,  4,  1,1280, 1,  True,  False, False,   False,   0,    0,    0)],
            ...
            1: {
                ...
                '5120' :[ h_traits('x', 'y', 'xs', 'ys', 'uqy', 1,  5,  1, 128, 8,  True,  False, False,   False,   0,    0,    1),
                          h_traits('x', 'y', 'xs', 'ys', 'uqy', 1,  4,  1,1280, 1,  True,  False, False,   False,   0,    0,    1)],

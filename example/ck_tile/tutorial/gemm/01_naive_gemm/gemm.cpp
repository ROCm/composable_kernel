...
int main(int argc, char* argv[])
{
    ...
    printf("[config] WarpGemm: TransposedCDistribution ON  (A/B swapped, transposed C layout)\n");
#else
    printf("[config] WarpGemm: TransposedCDistribution OFF (standard layout)\n");
#endif
    ...
    constexpr ck_tile::index_t kWarpSize     = 64;

...
struct GroupedConvolutionBackwardWeightInvoker
{
                                ...
                                const ck_tile::stream_config& s)
    {
        ...
        constexpr ck_tile::index_t GemmWarpConfig::M_Warp_Tile;
        constexpr ck_tile::index_t GemmWarpConfig::N_Warp_Tile;
        constexpr ck_tile::index_t GemmWarpConfig::K_Warp_Tile;

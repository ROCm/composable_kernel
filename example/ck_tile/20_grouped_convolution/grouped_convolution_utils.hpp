...
auto create_args(int argc, char* argv[])
{
    ...
    arg_parser.insert("g", "2", "group dimension")
        ...
        .insert("lpad_d", "1", "left pad for d dimension")
        .insert("lpad_h", "1", "left pad for h dimension")
        .insert("lpad_w", "1", "left pad for w dimension")

        .insert("rpad_d", "1", "right pad for d dimension")
        .insert("rpad_h", "1", "right pad for h dimension")
        .insert("rpad_w", "1", "right pad for w dimension")

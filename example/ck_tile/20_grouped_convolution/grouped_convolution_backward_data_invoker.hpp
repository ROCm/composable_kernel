...
struct GroupedConvolutionBackwardDataInvoker
{
                                       ...
                                       const ck_tile::stream_config& s)
    {
        ...
        const ck_tile::index_t gemm_k = args.K_ * std::accumulate(args.filter_spatial_lengths_.begin(), args.filter_spatial_lengths_.end(), 1, std::multiplies<ck_tile::index_t>());

...
template <typename ADataType,
          ...
          typename BLayout,
          typename CLayout>
float gemm_calc(const ck_tile::GemmHostArgs& gemm_args, const ck_tile::stream_config& s)
{
    ...
    ck_tile::GemmDequantHostArgs<typename GemmPipelineProblem::ComputeDataType> args{
        gemm_args.a_ptr,
        gemm_args.b_ptr,
        gemm_args.c_ptr,
        gemm_args.k_batch,
        ...
        gemm_args.stride_B,
        gemm_args.stride_C,
        ck_tile::type_convert<typename GemmPipelineProblem::ComputeDataType>(2.f)};
    ...
    const auto Run = [&](const auto has_hot_loop_, const auto tail_number_) {
        ...
        using GemmPipeline =
            GEMM_PIPELINE<UniversalGemmProblem, ck_tile::UniversalGemmDequantPipelineAgBgCrPolicy>;
...
#endif
    else { throw std::runtime_error("Unsupported data type for this operation !!!"); }
}

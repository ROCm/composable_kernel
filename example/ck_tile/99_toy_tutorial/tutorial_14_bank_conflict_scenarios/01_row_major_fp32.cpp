...
{
    std::cout << "\n========================================\n";
    std::cout << "Tutorial 14.01: Row-Major Transpose (FP32)\n";
    std::cout << "========================================\n\n";

    std::cout << "Layout: Row-major [M, K] = [64, 32]\n";
    std::cout << "Write: Row-wise (conflict-free for FP32)\n";
    ...
    std::cout << "\nExpected: ~3,500-4,000 conflicts (only READ, no WRITE pairing)\n";
    std::cout << "Reason: FP32 elements are 4 bytes (no pairing conflicts on write)\n";

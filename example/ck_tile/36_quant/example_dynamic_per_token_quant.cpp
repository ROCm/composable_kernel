...
int main()
{
    ...
    static constexpr ck_tile::index_t Repeat_N_ = 64;
    
    static constexpr ck_tile::index_t ThreadPerBlock_M_ = 64;
    static constexpr ck_tile::index_t ThreadPerBlock_N_ = 1;
    ...
    using Pipeline = ck_tile::DynamicPerTokenQuantPipeline<PipelineProblem>;

    using Kernel = ck_tile::PerTokenQuant<Pipeline>;

    int m = 64;
    int n = 64;
    int x_stride = n;
    ck_tile::HostTensor<XDataType> x_host({m, n}, {x_stride, 1});
    ck_tile::HostTensor<ScaleDataType> scale_host({m}, {1});
    ...
    ck_tile::FillStepRange<XDataType>{1, 3}(x_host);
    ...
    ck_tile::reference_per_token_quantization2d<XDataType, ScaleDataType, QXDataType>(

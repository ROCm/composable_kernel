...
{
    using GemmShape = ck_tile::TileGemmShape_blcok_quant<
        ck_tile::sequence<GemmConfig_fp8::M_Tile, GemmConfig_fp8::N_Tile, GemmConfig_fp8::K_Tile>,
        ck_tile::sequence<GemmConfig_fp8::M_Warp, GemmConfig_fp8::N_Warp, GemmConfig_fp8::K_Warp>,
        ck_tile::
            sequence<GemmConfig_fp8::M_Warp_Tile, GemmConfig_fp8::N_Warp_Tile, GemmConfig_fp8::K_Warp_Tile>,
        GemmConfig::PermuteA,
        GemmConfig::PermuteB>;
...
int run_gemm_example(int argc, char* argv[])
{
    ...
    if(data_type == "fp8")
    {
        return run_gemm_example_prec_type<ck_tile::fp8_t, ck_tile::fp8_t, ck_tile::bf16_t>(
            a_layout, b_layout, argc, argv);
    }

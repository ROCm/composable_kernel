...
QSCALE_MAP = {
    ...
    "q_pertensor_kv_blockscale": "ck_tile::BlockAttentionQuantScaleEnum::Q_PERTENSOR_KV_BLOCKSCALE",
}
...
QSCALE_CHECK_MAP = {
    ...
    "q_pertensor_kv_blockscale": "quant_scale_enum::q_pertensor_kv_blockscale",
}

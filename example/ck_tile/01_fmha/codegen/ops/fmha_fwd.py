...
K0_MAX_SUBMAX_MAP = {32: 32, 48: 48, 64: 64, 96: 96, 128: 128, 192: 192, 256: 256}
    ...
    def get_hdim_tile_size_dict(cls, dtype: str) -> Optional[dict]:
        if dtype in cls._DT_FP32:
            ...
            return {
                ...
                # ( 96, 96)  : [FmhaFwdTileSize(64,   64,  32,  96,  32,  96,  4, 1, 1,  4, 1, 1,  16, 16, 32,  16, 16, 32,  -1)],
                ( 96, 96)  : [FmhaFwdTileSize(128, 128,  32,  96,  32,  96,  4, 1, 1,  4, 1, 1,  32, 32, 16,  32, 32, 16,  -1)],

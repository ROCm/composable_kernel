        ...
        if dtype in ['fp16', 'bf16']:
            for mask, bias, lse, dropout in itertools.product(get_mask_map(mask_impl).keys(), BIAS_MAP.keys(), ["t", "f"], ["t", "f"]):
                ...
                # if True:
                    ...
                    pipelines.append(FmhaFwdPipeline('qr', 'row', 'f', 'f', 't', 't', bias, lse, dropout, squant, mask))
                    pipelines.append(FmhaFwdPipeline('qr', 'col', 'f', 'f', 't', 't', bias, lse, dropout, squant, mask))

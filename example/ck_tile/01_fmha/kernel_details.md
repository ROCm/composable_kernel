...
These arguments are generated by the `MakeKargsImpl` function in `example/ck_tile/01_fmha/fmha_fwd.hpp`. The basic version comprises 28 arguments (Using {} still consumes argument space):
  - q_ptr,
  - k_ptr,
  - v_ptr,
  - o_ptr,

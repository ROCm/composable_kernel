...
struct FmhaBspFwdFp16
{
};

struct FmhaBspFwdBf16
{
};

template <typename DataType>
struct FmhaBspFwdTypeConfig;
...
template <typename FmhaBspKernel>
auto fmha_bsp_fwd_create_kargs_and_grids(fmha_bsp_fwd_args args)
{
...
template <ck_tile::index_t HDim_,
          ...
          ck_tile::BlockFmhaBspPipelineEnum FmhaPipelineEnum_,
          typename FmhaMask_,
...
float fmha_bsp_fwd_(const ck_tile::stream_config&, fmha_bsp_fwd_args);

// This is the public API, will be generated by script
struct fmha_bsp_fwd_traits
{
    int hdim_q;
    int hdim_v;

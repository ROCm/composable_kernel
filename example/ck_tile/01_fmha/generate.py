...
# MASK_IMPL = {
#     "diagonal"   : "ck_tile::GenericAttentionMask",
#     "bigbird"    : "ck_tile::SimplifiedGenericAttentionMask"
#     "longformer" : ""
# }
...
MASK_MAP = {
    ...
    "generic" : "FmhaMasks::GenericDiagonalMask"
}
...
using fmha_trait_{F_idx} = ck_tile::TileFmhaTraits<{F_spad},
                                                    ...
                                                    {F_squant},
                                                    {F_occupancy}>;
using fmha_mask_{F_idx} = {F_mask}<fmha_shape_{F_idx}::kM0, fmha_shape_{F_idx}::kN0>;
...
FMHA_FWD_API_INNER_DISPATCH="""            {F_if}((t.is_group_mode == {F_mode}) && (t.is_v_rowmajor == {F_vlayout}) && ({F_mask_check}) && (t.bias_type == {F_bias_check}) && (t.has_lse == {F_lse})  && (t.has_dropout == {F_dropout}) && (t.do_fp8_static_quant == {F_squant}) &&
                ...
                using trait_ = fmha_fwd_traits_<{F_hdim}, {F_dtype}, {F_mode}, {F_bm0}, {F_bn0}, {F_bk0}, {F_bn1}, {F_bk1}, {F_bk0blen}, {F_vlayout}, {F_pipeline_enum}, {F_mask}<{F_bm0}, {F_bn0}>, {F_bias}, {F_lse}, {F_dropout}, {F_squant}, {F_spad}, {F_skpad}, {F_dpad}, {F_dvpad}>;

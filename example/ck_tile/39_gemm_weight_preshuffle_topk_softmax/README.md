...
make tile_example_gemm_weight_preshuffle_topk_softmax -j128
```
This will result in an executable `build/bin/tile_example_gemm_weight_preshuffle_topk_softmax`

./bin/tile_example_gemm_weight_preshuffle_topk_softmax -v=1 -m=4096 -n=256 -k=7168

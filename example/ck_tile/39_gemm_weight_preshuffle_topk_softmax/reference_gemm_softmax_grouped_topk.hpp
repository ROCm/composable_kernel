...
void reference_pw_gemm_softmax_grouped_topk(const ck_tile::HostTensor<ADataType>& a_m_k,
                          ...
                          ck_tile::index_t topk)
{
    ...
    const int K = b_k_n.mDesc.get_lengths()[0];
    const int N = b_k_n.mDesc.get_lengths()[1];

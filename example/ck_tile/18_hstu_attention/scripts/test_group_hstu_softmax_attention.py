#!/usr/bin/env python3
"""Run the grouped HSTU softmax attention forward correctness tests.

Python port of test_group_hstu_softmax_attention.sh, keeping the same
functionality and argument list:

    test_group_hstu_softmax_attention.py [norm_dist ...]
...
# Training mirrors `Training=${TEST_HSTU_FWD_TRAINING:-0}` in the shell script.

#!/usr/bin/env python3
"""Benchmark HSTU attention forward, jagged causal, mattn256 full256.

Python port of bench_jagged_causal_mattn256_full256.sh, keeping the same
functionality and argument list:

    bench_jagged_causal_mattn256_full256.py [use_softmax]
...
def main():
    parser = argparse.ArgumentParser(
        description="Benchmark HSTU attention backward (jagged causal mattn256 full256).")

#!/usr/bin/env python3
"""Run the HSTU softmax attention backward correctness tests with dropout.

Python port of test_hstu_softmax_attention_with_dropout_bwd.sh, keeping the same
functionality and argument list:

    test_hstu_softmax_attention_with_dropout_bwd.py [attn_scale] [norm_dist]
...
def main():
    parser = argparse.ArgumentParser(
        description="Run HSTU softmax attention backward correctness tests with "
                    "dropout.")

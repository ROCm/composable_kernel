#!/usr/bin/env python3
"""Run the grouped HSTU attention (with dropout) backward correctness tests.

Python port of test_group_hstu_attention_with_dropout_bwd.sh, keeping the same functionality
and argument list:

    test_group_hstu_attention_with_dropout_bwd.py [norm_dist] [extra]

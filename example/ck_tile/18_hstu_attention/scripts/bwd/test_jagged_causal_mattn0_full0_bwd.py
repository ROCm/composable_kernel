#!/usr/bin/env python3
"""Run the HSTU attention backward jagged-causal (mattn0/full0) tests.

Python port of test_jagged_causal_mattn0_full0_bwd.sh, keeping the same
functionality and argument list:

    test_jagged_causal_mattn0_full0_bwd.py [use_softmax]

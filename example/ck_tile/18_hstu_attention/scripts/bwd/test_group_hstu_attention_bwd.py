#!/usr/bin/env python3
"""Run the grouped HSTU attention backward correctness tests.

Python port of test_group_hstu_attention_bwd.sh, keeping the same functionality
and argument list:

    test_group_hstu_attention_bwd.py [norm_dist] [extra]

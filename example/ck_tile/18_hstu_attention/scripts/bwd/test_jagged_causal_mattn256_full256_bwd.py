#!/usr/bin/env python3
"""Run the HSTU attention backward jagged-causal (mattn256/full256) tests.

Python port of test_jagged_causal_mattn256_full256_bwd.sh, keeping the same
functionality and argument list:

    test_jagged_causal_mattn256_full256_bwd.py [use_softmax]

The single optional positional argument selects whether softmax is enabled and
defaults to 0, matching the original shell script.
"""

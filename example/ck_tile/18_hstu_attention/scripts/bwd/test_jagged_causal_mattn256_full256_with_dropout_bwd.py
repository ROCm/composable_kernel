#!/usr/bin/env python3
"""Run the HSTU attention backward jagged-causal (mattn256/full256) dropout tests.

Python port of test_jagged_causal_mattn256_full256_with_dropout_bwd.sh, keeping
the same functionality and argument list:

    test_jagged_causal_mattn256_full256_with_dropout_bwd.py [use_softmax]
...
def main():
    parser = argparse.ArgumentParser(
        description="Run HSTU attention backward jagged-causal "
                    "(mattn256/full256) dropout tests.")

#!/usr/bin/env python3
"""Run the grouped HSTU attention forward correctness tests (with dropout).

Python port of test_group_hstu_attention_with_dropout.sh, keeping the same
functionality and argument list:

    test_group_hstu_attention_with_dropout.py [norm_dist ...]

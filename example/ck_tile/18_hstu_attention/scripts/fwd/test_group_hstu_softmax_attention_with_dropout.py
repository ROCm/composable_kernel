#!/usr/bin/env python3
"""Run the grouped HSTU softmax attention forward tests (with dropout).

Python port of test_group_hstu_softmax_attention_with_dropout.sh, keeping the
same functionality and argument list:

    test_group_hstu_softmax_attention_with_dropout.py [norm_dist ...]
...
EXE_PREFIX = [EXE, "-softmax=1", f"-training={TRAINING}", "-p_drop=0.2"]

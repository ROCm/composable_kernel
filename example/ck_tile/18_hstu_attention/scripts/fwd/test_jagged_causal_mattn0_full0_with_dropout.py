#!/usr/bin/env python3
"""Run the HSTU attention forward jagged-causal (mattn0/full0) dropout tests.

Python port of test_jagged_causal_mattn0_full0_with_dropout.sh, keeping the
same functionality and argument list:

    test_jagged_causal_mattn0_full0_with_dropout.py [use_softmax]
...
def main():
    parser = argparse.ArgumentParser(
        description="Run HSTU attention forward jagged-causal mattn0/full0 dropout tests.")

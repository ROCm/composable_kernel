#!/usr/bin/env python3
"""Run the HSTU softmax attention forward correctness tests.

Python port of test_hstu_softmax_attention.sh, keeping the same functionality
and argument list:

    test_hstu_softmax_attention.py [attn_scale] [norm_dist]
...
(default 0), matching the original shell script.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Run HSTU softmax attention forward correctness tests.")

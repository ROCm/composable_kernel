#!/usr/bin/env python3
"""Run the HSTU attention forward jagged-causal (mattn256/full256) tests.

Python port of test_jagged_causal_mattn256_full256.sh, keeping the same
functionality and argument list:

    test_jagged_causal_mattn256_full256.py [use_softmax]
...
def main():
    parser = argparse.ArgumentParser(
        description="Run HSTU attention forward jagged-causal mattn256/full256 tests.")

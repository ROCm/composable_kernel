...
struct HstuAttentionNoSoftmaxBwdPipelineQRKSVS_dQ
{
               ...
               DropoutType& dropout) const
    {
        ...
        //   [k_lds | v_lds | kt_lds]
        // k_lds  and v_lds  : double-buffered [kN0Sub, kQKHeaddim], invariant view for
        // write/read kt_lds: complete-buffered [kQKHeaddim, kN0Sub], transposed view [kN0Sub,
        // kQKHeaddim] for write
        ...
        static_for<0, n0_loops, 1>{}([&](auto i_buf) {
            kt_lds_read_windows[i_buf] =
                get_slice_tile(kt_lds_read_monolithic_window,
                               sequence<i_buf * kQKHeaddim, 0>{},
                               sequence<(i_buf + 1) * kQKHeaddim, kN0Sub>{});
        });

...
//   Loop 1 (m0_loops): Gemm0 (S = Q@K); Q prefetched (via TDM) into q_lds.
//   Loop 2 (m0_loops): Gemm2 (dP = dO@V); dO prefetched (via TDM) into do_lds.
...
//
// LDS layout (double-buffered regions):
//   q_lds   : [kM0Sub, kQKHeaddim] x m0_loops x 2, normal write/read and transposed loading
//   do_lds  : [kM0Sub, kVHeaddim] x m0_loops x 2, normal write/read and transposed loading
template <typename Problem_,
          typename Traits_,
          typename Policy_ = HstuAttentionBwdKernel2PipelinePolicy>
struct HstuAttentionWithSoftmaxBwdTdmTrLoadPipelineKRVRQS_dK_dV
{

...
struct HstuAttentionWithSoftmaxBwdTrLoadPipelineKRVRQS_dK_dV
{
                                   ...
                                   DropoutType& dropout) const
    {
        ...
        statically_indexed_array<q_lds_trload_window_type, m0_loops> q_lds_trload_windows;
        ...
        statically_indexed_array<do_lds_trload_window_type, m0_loops> do_lds_trload_windows;
        static_for<0, m0_loops, 1>{}([&](auto i_buf) {

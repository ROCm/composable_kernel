...
struct f8_to_fp16
{
    __host__ __device__ void operator()(ck::half_t& y, const ck::f8_t& x) const
    {
        y = ck::type_convert<ck::half_t>(x) * scale;
    }
...
using AElementOp   = f8_to_fp16;
using BElementOp   = f8_to_fp16;
using CDEElementOp = Relu;

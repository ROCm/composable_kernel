...
int run(int argc, char* argv[])
{
    ...
    Tensor<AccDataType> d_gs_ms(d_gs_ms_lengths, d_gs_ms_strides);
    ...
    DeviceMem d_device_buf(sizeof(AccDataType) * d_gs_ms.mDesc.GetElementSpaceSize());
    ...
    // get z matrix
    {
        auto argument = gemm.MakeArgument(
            ...
            static_cast<AccDataType*>(d_device_buf.GetDeviceBuffer()),

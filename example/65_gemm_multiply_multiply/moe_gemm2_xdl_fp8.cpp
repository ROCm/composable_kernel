...
///###### RCR
        ...
        <      Row,      Col, DsLayout, ELayout, A0DataType, B0DataType, DsDataType, EDataType, AccDataType, CShuffleDataType,
            ...
            //    S<16, 16, 1>, S<1, 0, 2>, S<1, 0, 2>, 2, 8, 8, 0,
               ...
               ck::BlockGemmPipelineScheduler::Intrawave, ck::BlockGemmPipelineVersion::v1, 0, false, false, MulRoutedWeight, true, int32_t, A0DataType>;
...
int main(int argc, char* argv[])
{
    ...
    Tensor<D0DataType> d0_t_n(HostTensorDescriptor({tokens, topk, N}, {StrideDs[0], StrideDs[0], 0}));

...
struct GridwiseGemm_bk0mk1_bk0nk1_mn_xdlops_v2r4r2_simplified
{
    ...
    __device__ static void Run(const Argument& karg, void* __restrict__ p_shared_block)
    {
        ...
        //     C:%dx%dx%dx%d(%d)\n",
        //         __builtin_amdgcn_readfirstlane(blockIdx.x), k_batch_id, m_block_data_idx_on_grid,
        //         n_block_data_idx_on_grid,
        //         __builtin_amdgcn_readfirstlane(a_b_k0_m_k1_grid_desc.GetLength(I0)),
        //         __builtin_amdgcn_readfirstlane(a_b_k0_m_k1_grid_desc.GetLength(I1)),
        //         __builtin_amdgcn_readfirstlane(a_b_k0_m_k1_grid_desc.GetLength(I2)),
        //         __builtin_amdgcn_readfirstlane(a_b_k0_m_k1_grid_desc.GetLength(I3)),
        //         __builtin_amdgcn_readfirstlane(a_b_k0_m_k1_grid_desc.GetElementSpaceSize()),
        //         __builtin_amdgcn_readfirstlane(b_b_k0_n_k1_grid_desc.GetLength(I0)),
        //         __builtin_amdgcn_readfirstlane(b_b_k0_n_k1_grid_desc.GetLength(I1)),
        //         __builtin_amdgcn_readfirstlane(b_b_k0_n_k1_grid_desc.GetLength(I2)),
        //         __builtin_amdgcn_readfirstlane(b_b_k0_n_k1_grid_desc.GetLength(I3)),
        //         __builtin_amdgcn_readfirstlane(b_b_k0_n_k1_grid_desc.GetElementSpaceSize()),
        //         __builtin_amdgcn_readfirstlane(c_grid_desc_mblock_mperblock_nblock_nperblock.GetLength(I0)),
        //         __builtin_amdgcn_readfirstlane(c_grid_desc_mblock_mperblock_nblock_nperblock.GetLength(I1)),
        //         __builtin_amdgcn_readfirstlane(c_grid_desc_mblock_mperblock_nblock_nperblock.GetLength(I2)),
        //         __builtin_amdgcn_readfirstlane(c_grid_desc_mblock_mperblock_nblock_nperblock.GetLength(I3)),
        //         __builtin_amdgcn_readfirstlane(c_grid_desc_mblock_mperblock_nblock_nperblock.GetElementSpaceSize())
        //     );
        // }

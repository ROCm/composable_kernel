...
using PassThroughPack2 = ck::tensor_operation::element_wise::PassThroughPack2;
...
int main(int argc, char* argv[])
{
    ...
    constexpr ck::index_t NumATensor = AsDataType::Size();
    constexpr ck::index_t NumBTensor = BsDataType::Size();
    ...
    if(do_verification)
    {
        ...
        auto ref_argument = ref_gemm.MakeArgument(
            a0_m_k, b0_k_n, e_m_n_host_result, PassThrough{}, PassThrough{}, PassThrough{});

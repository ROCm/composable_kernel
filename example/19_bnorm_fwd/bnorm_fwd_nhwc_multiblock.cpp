...
using DeviceBatchNormFwdInstance = DeviceBatchNormFwd_Input_N_H_W_C_Output_C_With_Reduce_Multiblock<
    InOutDataType,
    AccDataType,
    256, // BlockSize
...
int main(int argc, char* argv[])
{
    ...
    // currently, input data is accessed from device memory separately for computing the mean and
    // meansquare, later the implementation will be fused as well as accessing the input data from
    // device memory
    std::size_t num_bytes = 2 * arg.inOutLengths[0] * arg.inOutLengths[1] * arg.inOutLengths[2] *

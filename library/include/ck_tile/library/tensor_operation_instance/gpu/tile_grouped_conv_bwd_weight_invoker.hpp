...
struct GroupedConvolutionBackwardWeightBaseInvoker
{
    ...
    virtual float Run(const ck_tile::GroupedConvBwdWeightHostArgs& args,
                      bool time_kernel,
                      int n_warmup,
    ...
    GroupedConvolutionBackwardWeightBaseInvoker(
        const GroupedConvolutionBackwardWeightBaseInvoker&) = default;
    GroupedConvolutionBackwardWeightBaseInvoker&
    operator=(const GroupedConvolutionBackwardWeightBaseInvoker&) = default;
    GroupedConvolutionBackwardWeightBaseInvoker(GroupedConvolutionBackwardWeightBaseInvoker&&) =
        default;
    GroupedConvolutionBackwardWeightBaseInvoker&
    operator=(GroupedConvolutionBackwardWeightBaseInvoker&&) = default;
                                                         ...
                                                         OutElementwiseOperation>
{
    ...
    using GemmUniversalTraits = ck_tile::TileGemmUniversalTraits<
        ...
        typename GroupedConvTraitsType::template GroupedConvImplicitGemmTraitsBwdWeight<
            1>::BsLayout,
        typename GroupedConvTraitsType::template GroupedConvImplicitGemmTraitsBwdWeight<1>::CLayout,
    ...
    using GemmPipelineProblem = ck_tile::GemmPipelineProblem<
        ...
        AccDataType,
        GemmShape,
        typename GroupedConvTraitsType::template GroupedConvImplicitGemmTraitsBwdWeight<1>,
    ...
    auto CreateKernel() const
    {
        ...
        return ck_tile::GroupedConvolutionBackwardWeightKernel<GroupedConvTraitsType,
                                                               TilePartitioner,
                                                               GemmPipeline,
                                                               ConvEpilogue>{};
    }
    ...
    float Run(const ck_tile::GroupedConvBwdWeightHostArgs& args,
              bool time_kernel,
              int n_warmup = 5,
    ...
    GroupedConvolutionBackwardWeightInvoker(const GroupedConvolutionBackwardWeightInvoker&) =
        default;
    GroupedConvolutionBackwardWeightInvoker&
    operator=(const GroupedConvolutionBackwardWeightInvoker&)                          = default;
    GroupedConvolutionBackwardWeightInvoker(GroupedConvolutionBackwardWeightInvoker&&) = default;
    GroupedConvolutionBackwardWeightInvoker&
    operator=(GroupedConvolutionBackwardWeightInvoker&&) = default;

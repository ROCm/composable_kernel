...
//     std::vector<std::unique_ptr<
//         DeviceGemm<Col, Row, Row, int8_t, int8_t, int8_t, PassThrough, PassThrough,
...
//     std::vector<std::unique_ptr<
//         DeviceGemm<Col, Col, Row, int8_t, int8_t, int8_t, PassThrough, PassThrough,
//         PassThrough>>>& instances);
...
//     std::vector<std::unique_ptr<
//         DeviceGemm<Row, Row, Row, int8_t, int8_t, int8_t, PassThrough, PassThrough,
//         PassThrough>>>& instances);
...
//     std::vector<std::unique_ptr<
//         DeviceGemm<Row, Col, Row, int8_t, int8_t, int8_t, PassThrough, PassThrough,
//         PassThrough>>>& instances);
...
void add_device_gemm_xdl_direct_c_write_out_f16_f16_f16_mk_nk_mn_instances_spv8(
    std::vector<std::unique_ptr<
        DeviceGemm<Row, Col, Row, F16, F16, F16, PassThrough, PassThrough, PassThrough>>>&
        instances);

void add_device_gemm_xdl_direct_c_write_out_f16_f16_f16_mk_nk_mn_instances_spv4(
    std::vector<std::unique_ptr<
        DeviceGemm<Row, Col, Row, F16, F16, F16, PassThrough, PassThrough, PassThrough>>>&
        instances);

void add_device_gemm_xdl_direct_c_write_out_f16_f16_f16_mk_nk_mn_instances_spv2(
    std::vector<std::unique_ptr<
        DeviceGemm<Row, Col, Row, F16, F16, F16, PassThrough, PassThrough, PassThrough>>>&
        instances);
    ...
    static auto GetInstances()
    {
                          ...
                          is_same_v<CDataType, half_t>)
        {
                                  ...
                                  is_same_v<CLayout, Row>)
            {
                ...
                add_device_gemm_xdl_direct_c_write_out_f16_f16_f16_mk_nk_mn_instances_spv8(op_ptrs);
                add_device_gemm_xdl_direct_c_write_out_f16_f16_f16_mk_nk_mn_instances_spv4(op_ptrs);
                add_device_gemm_xdl_direct_c_write_out_f16_f16_f16_mk_nk_mn_instances_spv2(op_ptrs);
            }
            // else if constexpr(is_same_v<ALayout, Col> && is_same_v<BLayout, Row> &&
            //                   is_same_v<CLayout, Row>)
            // {

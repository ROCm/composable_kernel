...
using device_grouped_conv_fwd_wmma_large_tensor_bf16_instances = std::tuple<
    // clang-format off
        ...
        ,
        DeviceGroupedConvFwdMultipleD_Wmma_CShuffle_V3_Large_Tensor<NDSpatial, ALayout, BLayout, DsLayout, ELayout,  BF16,  BF16,     F32,     BF16, DsDataType,   BF16,  PassThrough, PassThrough, CDEElementOp,       ConvSpec, GemmMNKPadding,   256,   256,   256,   128,  8,    16,   16,       8,       4,    S<16, 16, 1>,     S<1, 0, 2>,     S<1, 0, 2>,              2,              8,              8,         1,    S<16, 16, 1>,     S<1, 0, 2>,     S<1, 0, 2>,             2,              8,              8,         1,           1,           1,               S<1, 32, 1, 8>,               1>
    #endif
    // clang-format on
    >;

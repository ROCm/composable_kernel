...
void add_device_grouped_gemm_multiple_d_dl_f16_f16_f16_mk_kn_mn_instances(
    std::vector<std::unique_ptr<DeviceGroupedGemm<Row,
                                                  Row,
                                                  Empty_Tuple,
                                                  Row,
    ...
    static auto GetInstances()
    {
                     ...
                     is_same_v<EDataType, half_t>)
        {
                         ...
                         is_same_v<ELayout, Row>)
            {
                ...
                add_device_grouped_gemm_multiple_d_dl_f16_f16_f16_mk_kn_mn_instances(op_ptrs);
            }
            else if constexpr(is_same_v<ALayout, Row> && is_same_v<BLayout, Col> &&
                              is_same_v<ELayout, Row>)
            {
                add_device_grouped_gemm_xdl_f16_f16_f16_mk_nk_mn_instances(op_ptrs);
                add_device_grouped_gemm_multiple_d_dl_f16_f16_f16_mk_nk_mn_instances(op_ptrs);
            }

                     ...
                     is_same_v<EDataType, half_t>)
        {
                         ...
                         is_same_v<ELayout, Row>)
            {
                ...
                add_device_grouped_gemm_xdl_splitk_f16_f16_f16_mk_kn_mn_irregular_instances(
                    op_ptrs);
                add_device_grouped_gemm_xdl_splitk_direct_c_write_out_f16_f16_f16_mk_kn_mn_irregular_instances(
                    op_ptrs);
            }
                              ...
                              is_same_v<ELayout, Row>)
            {
                ...
                add_device_grouped_gemm_xdl_splitk_f16_f16_f16_mk_nk_mn_irregular_instances(
                    op_ptrs);
                add_device_grouped_gemm_xdl_splitk_direct_c_write_out_f16_f16_f16_mk_nk_mn_irregular_instances(
                    op_ptrs);
            }

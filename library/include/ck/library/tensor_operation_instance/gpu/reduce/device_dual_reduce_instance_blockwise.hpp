...
using dual_reduce_configuration_1_instances_blockwise = std::tuple<
    // clang-format off
...
using dual_reduce_configuration_2_instances_blockwise = std::tuple<
    // clang-format off
...
using deviceDualReduceBlockWisePtrType =
...
template <typename InDataType,
          ...
          int Rank,
          int NumReduceDim>
void add_device_dual_reduce_instance_blockwise(
    std::vector<deviceDualReduceBlockWisePtrType<InElementwiseOperation1,
                                                 AccElementwiseOperation1,
                                                 InElementwiseOperation2,
                                                 AccElementwiseOperation2>>& device_op_instances)
{
    static_for<0, std::tuple_size<dual_reduce_configuration_1_instances_blockwise>::value, 1>{}(
        [&](auto i) {
            using cfg1 = remove_cvref_t<decltype(
                std::get<i.value>(dual_reduce_configuration_1_instances_blockwise{}))>;

            static_for<0,
                       std::tuple_size<dual_reduce_configuration_2_instances_blockwise>::value,
                       1>{}([&](auto j) {
                using cfg2 = remove_cvref_t<decltype(
                    std::get<j.value>(dual_reduce_configuration_2_instances_blockwise{}))>;
...
#define ADD_DUAL_REDUCE_BLOCKWISE_INST(inT,                                    \
                                       compT,                                  \
                                       outT1,                                  \
                                       outT2,                                  \
                                       ReduceOperation,                        \
                                       ...
                                       Rank,                                   \
                                       NumReduceDim)                           \
    template void add_device_dual_reduce_instance_blockwise<inT,               \
                                                            compT,             \
                                                            outT1,             \
                                                            outT2,             \
                                                            ReduceOperation,   \
                                                            ...
                                                            Rank,              \
                                                            NumReduceDim>(     \
        std::vector<deviceDualReduceBlockWisePtrType<InElementwiseOp1,         \
                                                     AccElementwiseOp1,        \
                                                     InElementwiseOp2,         \
                                                     AccElementwiseOp2>> &     \
        device_op_instances)

#define ADD_DUAL_REDUCE_BLOCKWISE_INST_REF(inT,                                       \
                                           compT,                                     \
                                           outT1,                                     \
                                           outT2,                                     \
                                           ReduceOperation,                           \
                                           ...
                                           Rank,                                      \
                                           NumReduceDim)                              \
    extern template void add_device_dual_reduce_instance_blockwise<inT,               \
                                                                   compT,             \
                                                                   outT1,             \
                                                                   outT2,             \
                                                                   ReduceOperation,   \

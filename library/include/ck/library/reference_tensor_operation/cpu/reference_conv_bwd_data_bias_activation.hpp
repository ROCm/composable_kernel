...
struct ReferenceConvBwdDataBiasActivation : public device::BaseOperator
{
    // Argument
    ...
    {
        using Argument = ReferenceConvBwdDataBiasActivation::Argument;
        ...
        float Run(const Argument& arg)
        {
            ...
            if constexpr(NDimSpatial == 1)
            {
                auto f_ncw = [&](auto g, auto n, auto c, auto wi) {
                    ...
                    arg.in_element_op_(v_in, v_acc, static_cast<float>(arg.bias_(c)));
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "ReferenceConvBwdDataBiasActivation"
            << std::endl;
        // clang-format on

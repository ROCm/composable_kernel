...
struct ReferenceMoeGemm2BlockScaleNonReduce : public device::BaseOperator
{
    // Argument
    ...
    {
        using Argument = ReferenceMoeGemm2BlockScaleNonReduce::Argument;
        ...
        float Run(const Argument& arg)
        {
            ...
            make_ParallelTensorFunctor(
                ...
                arg.c_t_n_.mDesc.GetLengths()[2])(std::thread::hardware_concurrency());

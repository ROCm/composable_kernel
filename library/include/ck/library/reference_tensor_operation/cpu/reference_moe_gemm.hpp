...
struct ReferenceMoeGemm : public device::BaseOperator
{
    ...
    struct Invoker : public device::BaseInvoker
    {
        ...
        float Run(const Argument& arg)
        {
            ...
            make_ParallelTensorFunctor(
                f_mk_kn_mn, max_token_id, arg.c_m_n_.mDesc.GetLengths()[1])(
    ...
    static auto MakeArgument(const Tensor<ck::index_t>& sorted_token_ids,
                             ...
                             CElementwiseOperation c_element_op)
    {
        return Argument{sorted_token_ids, expert_ids, max_token_id, sorted_tile_size, a_t_k, b_e_n_k, c_m_n, a_element_op, b_element_op, c_element_op};
    }

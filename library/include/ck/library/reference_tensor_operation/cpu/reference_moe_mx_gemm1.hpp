                ...
                if(t < token_cnt)
                {
                    for(int k = 0; k < K; ++k)
                    {
                        ...
                        if constexpr(is_same_v<BDataType, f4x2_pk_t>)
                        {
                            ...
                            auto f4x2_up    = arg.b_e_n_k_(e, k, n + full_n).data;
                        ...
                        else
                        {
                            ...
                            arg.b_element_op_(v_b_up,
                                              type_convert<ComputeTypeB>(arg.b_e_n_k_(e, k, n + full_n)));
                        }
                    ...
                    arg.c_element_op_(v_c_up, v_acc_up, 1.f, 1.f, 1.f);

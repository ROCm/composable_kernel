...
// a[k, m] * b[k, n] = e[m, n]
using device_grouped_gemm_wmma_universal_bf16_bf16_bf16_km_kn_mn_instances = std::tuple<
    // clang-format off
                                                  ...
                                                  CDEElementOp>>>& instances)
{
    add_device_operation_instances(
        instances, device_grouped_gemm_wmma_universal_bf16_bf16_bf16_km_kn_mn_instances{});
}

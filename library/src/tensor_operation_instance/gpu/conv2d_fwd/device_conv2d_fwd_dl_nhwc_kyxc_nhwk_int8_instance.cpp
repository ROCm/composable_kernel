...
using device_conv2d_dl_nhwc_kyxc_nhwk_int8_instances = std::tuple<
    // clang-format off
...
void add_device_conv2d_dl_nhwc_kyxc_nhwk_int8_instances(
...
{
    add_device_operation_instances(instances, device_conv2d_dl_nhwc_kyxc_nhwk_int8_instances{});
}

...
using device_conv2d_dl_nhwc_kyxc_nhwk_f32_instances = std::tuple<
    // clang-format off
...
void add_device_conv2d_dl_nhwc_kyxc_nhwk_f32_instances(
...
{
    add_device_operation_instances(instances, device_conv2d_dl_nhwc_kyxc_nhwk_f32_instances{});
}

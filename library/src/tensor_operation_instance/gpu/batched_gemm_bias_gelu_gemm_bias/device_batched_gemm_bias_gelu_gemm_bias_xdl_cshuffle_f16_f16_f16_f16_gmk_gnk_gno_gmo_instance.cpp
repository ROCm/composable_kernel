...
using device_batched_gemm_bias_gelu_gemm_bias_xdl_cshuffle_f16_f16_f16_f16_gmk_gnk_gno_gmo_instances =
    std::tuple<
        ...
        DeviceBatchedGemmBiasGeluGemmBias_Xdl_CShuffle<     Row,      Col,     Row,      Row,       Row,   ck::Tuple<Row>,   F16,    F16,      F32,          F16,     F16,     F32,      F32,      F16,   ck::Tuple<F16>, PassThrough, PassThrough, PassThrough, D0ElementOp, PassThrough, PassThrough, D1ElementOp,    true,        true,          true,       true,     true,       1,        256,    256,   128,    32,   128,    32,   8,    8,    2,   32,   32,     2,     4,     4,     S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,              2,              8,              8,          true,      S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,               2,               8,               8,       true,     S< 8, 32, 1>,      S<0, 2, 1>,      S<0, 2, 1>,               1,               4,               2,      false,           1,           2,               S<1, 32, 1, 8>,               8>,
        DeviceBatchedGemmBiasGeluGemmBias_Xdl_CShuffle<     Row,      Col,     Row,      Row,       Row,   ck::Tuple<Row>,   F16,    F16,      F32,          F16,     F16,     F32,      F32,      F16,   ck::Tuple<F16>, PassThrough, PassThrough, PassThrough, D0ElementOp, PassThrough, PassThrough, D1ElementOp,    true,        true,          true,       true,     true,       1,        256,    128,   128,    32,   128,    32,   8,    8,    2,   32,   32,     1,     4,     4,     S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,              2,              8,              8,          true,      S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,               2,               8,               8,       true,     S< 8, 32, 1>,      S<0, 2, 1>,      S<0, 2, 1>,               1,               4,               2,      false,           1,           2,               S<1, 32, 1, 8>,               8>,
        DeviceBatchedGemmBiasGeluGemmBias_Xdl_CShuffle<     Row,      Col,     Row,      Row,       Row,   ck::Tuple<Row>,   F16,    F16,      F32,          F16,     F16,     F32,      F32,      F16,   ck::Tuple<F16>, PassThrough, PassThrough, PassThrough, D0ElementOp, PassThrough, PassThrough, D1ElementOp,    true,        true,          true,       true,     true,       1,        256,    128,   128,    32,    64,    32,   8,    8,    2,   32,   32,     1,     4,     2,     S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,              2,              8,              8,          true,      S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,               2,               8,               8,       true,     S<16, 16, 1>,      S<0, 2, 1>,      S<0, 2, 1>,               1,               4,               2,      false,           1,           2,               S<1, 32, 1, 8>,               8>,
        DeviceBatchedGemmBiasGeluGemmBias_Xdl_CShuffle<     Row,      Col,     Row,      Row,       Row,   ck::Tuple<Row>,   F16,    F16,      F32,          F16,     F16,     F32,      F32,      F16,   ck::Tuple<F16>, PassThrough, PassThrough, PassThrough, D0ElementOp, PassThrough, PassThrough, D1ElementOp,    true,        true,          true,       true,     true,       1,        256,    128,    64,    32,   128,    32,   8,    8,    2,   32,   32,     1,     2,     4,     S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,              2,              8,              8,          true,      S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,               2,               8,               8,       true,     S< 8, 32, 1>,      S<0, 2, 1>,      S<0, 2, 1>,               1,               4,               2,      false,           1,           2,               S<1, 32, 1, 8>,               8>
        // clang-format on
        >;

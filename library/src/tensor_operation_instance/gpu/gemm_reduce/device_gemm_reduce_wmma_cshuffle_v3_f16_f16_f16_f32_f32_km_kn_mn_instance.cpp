...
// c[m, n] = a[k, m] * b[k, n]
using device_gemm_reduce_wmma_cshuffle_v3_f16_f16_f16_f32_f32_km_kn_mn_instances = std::tuple<
    // clang-format off

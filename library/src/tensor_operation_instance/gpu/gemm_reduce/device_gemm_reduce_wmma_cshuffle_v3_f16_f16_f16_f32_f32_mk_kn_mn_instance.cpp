...
// c[m, n] = a[m, k] * b[n, k]
using device_gemm_reduce_wmma_cshuffle_v3_f16_f16_f16_f32_f32_mk_kn_mn_instances = std::tuple<
    // clang-format off
        ...
        //##############################|        |        |        |     |      |      |         |         |          |                 |            |            |            |          |                   |                    |             |               |      |      |      |      |    |    |     |     |        |        |                |               |               |               |               |               |          |                |               |               |              |               |               |          |            |            |                                      |                         |                     |                          |                             |
        DeviceGemmReduce_Wmma_CShuffleV3<     Row,     Row,     Row,  F16,   F16,   F16,      F32,      F32,       F32, ReducePtrsGlobal, PassThrough, PassThrough, PassThrough, ReduceOps, ReduceInElementOps, ReduceOutElementOps,  ReduceMemOp,    GemmDefault,   256,   256,   128,    32,   2,   2,   16,   16,       8,       2,     S<4, 64, 1>,     S<1, 0, 2>,     S<1, 0, 2>,              2,              2,              2,         1,     S<8, 32, 1>,     S<0, 2, 1>,     S<0, 2, 1>,             1,              4,              2,         1,           1,           1,                        S<1, 32, 1, 8>,                        8,             S<32, 8>,                         4,                            1>
    // clang-format on
    >;
    ...
    std::vector<DeviceGemmReducePtr<0, ReducePtrsGlobal::Size()>>& instances)
{
    add_device_operation_instances(
        instances, device_gemm_reduce_wmma_cshuffle_v3_f16_f16_f16_f32_f32_mk_kn_mn_instances{});
}

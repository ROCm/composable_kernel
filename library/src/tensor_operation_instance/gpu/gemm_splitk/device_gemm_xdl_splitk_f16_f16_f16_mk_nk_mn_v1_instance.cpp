        ...
        instances)
{
    ...
    add_device_operation_instances(
        instances,
        device_gemm_xdl_splitk_f16_f16_f16_mk_nk_mn_v1_instances<GemmDefault,
                                                                 ck::PipelineVersion::v1,
                                                                 ck::LoopScheduler::Default>{});

    add_device_operation_instances(
        instances,
        device_gemm_xdl_splitk_f16_f16_f16_mk_nk_mn_v1_instances<GemmMNPadding,
                                                                 ck::PipelineVersion::v1,
                                                                 ck::LoopScheduler::Default>{});

    add_device_operation_instances(
        instances,
        device_gemm_xdl_splitk_f16_f16_f16_mk_nk_mn_v1_instances<GemmMNKPadding,
                                                                 ck::PipelineVersion::v1,
                                                                 ck::LoopScheduler::Default>{});
}

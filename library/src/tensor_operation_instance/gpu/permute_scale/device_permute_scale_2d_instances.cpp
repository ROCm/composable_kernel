...
{
    add_device_operation_instances(instances, device_permute_scale_f16_instances<2, UnaryScaleSquare>{});
}
...
{
    add_device_operation_instances(instances, device_permute_scale_f32_instances<2, UnaryScaleSquare>{});
}

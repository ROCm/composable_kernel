...
using device_gemm_xdl_c_shuffle_bf16_bf16_bf16_km_kn_mn_instances =
    std::tuple<
        ...
        DeviceGemmXdl_C_Shuffle<  BF16,   BF16,   BF16,     F32,      BF16,     Col,      Row,    Row, PassThrough, PassThrough, PassThrough,   256,   128,   256,    32,   2,   2,   32,   32,    2,    4,     S<8, 32, 1>,     S<0, 2, 1>,     S<0, 2, 1>,              1,              4,              2,     false,     S<4, 64, 1>,     S<0, 2, 1>,     S<0, 2, 1>,             1,              4,              2,     false,           1,           1,             S<1, 1, 32, 1, 1, 8>,               8>,
        ...
        DeviceGemmXdl_C_Shuffle<  BF16,   BF16,   BF16,     F32,      BF16,     Col,      Row,    Row, PassThrough, PassThrough, PassThrough,   256,   128,    64,    32,   2,   2,   32,   32,    2,    1,     S<8, 32, 1>,     S<0, 2, 1>,     S<0, 2, 1>,              1,              4,              2,     false,     S<16,16, 1>,     S<0, 2, 1>,     S<0, 2, 1>,             1,              4,              2,     false,           1,           1,             S<1, 1, 32, 1, 1, 8>,               8>,
        DeviceGemmXdl_C_Shuffle<  BF16,   BF16,   BF16,     F32,      BF16,     Col,      Row,    Row, PassThrough, PassThrough, PassThrough,   256,   128,    64,    32,   8,   8,   32,   32,    2,    1,     S<4, 64, 1>,     S<0, 2, 1>,     S<0, 2, 1>,              1,              2,              8,      true,     S<4, 64, 1>,     S<0, 2, 1>,     S<0, 2, 1>,             1,              1,              8,      true,           1,           1,             S<1, 1, 32, 1, 1, 8>,               8>,

...
void add_device_grouped_conv3d_bwd_weight_xdl_ndhwgc_gkzyxc_ndhwgk_f16_comp_bf8_f8_default_pipev2_instances(
...
#pragma message "These instances are getting deprecated"
    ...
    add_device_operation_instances(
        instances,
        device_grouped_conv_bwd_weight_v3_xdl_c_shuffle_f16_comp_bf8_f8_instances<
            3,
            NDHWGC,
            GKZYXC,
            NDHWGK,

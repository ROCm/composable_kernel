...
using device_gemm_bilinear_xdl_c_shuffle_f32_f32_f32_km_kn_mn_instances = std::tuple<
    // clang-format off
...
void add_device_gemm_bilinear_xdl_c_shuffle_f32_f32_f32_km_kn_mn_instances(
    std::vector<DeviceGemmBiasPtr<PassThrough, PassThrough, AlphaBetaAdd>>& instances)
{
    add_device_operation_instances(
        instances, device_gemm_bilinear_xdl_c_shuffle_f32_f32_f32_km_kn_mn_instances{});
}

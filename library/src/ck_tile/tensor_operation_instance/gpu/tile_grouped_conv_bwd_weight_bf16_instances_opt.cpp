...
#include "ck_tile/library/tensor_operation_instance/gpu/tile_grouped_conv_bwd_weight_bf16_instances_opt.hpp"
...
void add_grouped_conv2d_bwd_weight_bf16_instances_opt(std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances)
{
    add_device_operation_instances(instances,
                                   tile_grouped_conv_bwd_weight_bf16_instances_opt<
                                       2,
                                       NHWGC,
                                       GKYXC,
                                       NHWGK>{});

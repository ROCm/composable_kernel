...
std::string ToString(struct TileDesc td) { std::to_string(td.block_size) + ", " }
...
std::string ToString(struct BlockTransferDesc);
...
std::string ToString(struct CShuffleDesc);
...
std::string ToString(struct CBlockTransferDesc);

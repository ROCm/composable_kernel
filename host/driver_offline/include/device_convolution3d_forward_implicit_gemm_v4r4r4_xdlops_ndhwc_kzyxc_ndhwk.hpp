    ...
    ck::index_t nrepeat)
{
    ...
    const auto in_n_di_hi_wi_c_desc  = make_naive_tensor_descriptor_packed(in_n_di_hi_wi_c_lengths);
    const auto wei_k_z_y_x_c_desc   = make_naive_tensor_descriptor_packed(wei_k_z_y_x_c_lengths);
    const auto out_n_do_ho_wo_k_desc = make_naive_tensor_descriptor_packed(out_n_do_ho_wo_k_lengths);

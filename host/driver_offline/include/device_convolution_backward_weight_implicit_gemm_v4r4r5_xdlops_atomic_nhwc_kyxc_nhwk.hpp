    ...
    ck::index_t nrepeat)
{
    ...
    const auto descs =
        transform_backward_weight_convolution_into_gemm_v4r4r5_nhwc_kyxc_nhwk(in_n_hi_wi_c_desc,
                                                                              wei_k_y_x_c_desc,
                                                                              out_n_ho_wo_k_desc,
                                                                              conv_strides,
                                                                              conv_dilations,
    ...
    constexpr auto in_gemmkbatch_gemmk0_gemmn_gemmk1_grid_step_hacks =

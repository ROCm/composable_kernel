...

{
...

    {
        std::cout << "a_s_k0_m_k1_grid_desc{" << a_s_k0_m_k1_grid_desc.GetLength(I0) << ", "
                  << a_s_k0_m_k1_grid_desc.GetLength(I1) << ", " << a_s_k0_m_k1_grid_desc.GetLength(I2) << ", " << a_s_k0_m_k1_grid_desc.GetLength(I3)
                  << "}" << std::endl;
        ...
        std::cout << "c_s_m_n_grid_desc{ " << c_s_m_n_grid_desc.GetLength(I0) << ", "
                  << c_s_m_n_grid_desc.GetLength(I1) << ", " << c_s_m_n_grid_desc.GetLength(I2) << "}" << std::endl;
    }
    ...
    const auto a_batch_stride = a_s_k0_m_k1_grid_desc.CalculateOffset(make_multi_index(1, 0, 0, 0)) - a_s_k0_m_k1_grid_desc.CalculateOffset(make_multi_index(0, 0, 0, 0));
    const auto c_batch_stride = c_s_m_n_grid_desc.CalculateOffset(make_multi_index(1, 0, 0)) - c_s_m_n_grid_desc.CalculateOffset(make_multi_index(0, 0, 0));
    ...
    // printf("%s: %d %ld %ld\n", __FILE__, __LINE__, c_s_m_n_grid_desc.GetElementSpaceSize(), c_s_m_n_grid_desc.GetElementSize());
    // printf("%s: %d %ld %ld\n", __FILE__, __LINE__, c_s_m0_n0_m1_n1_m2_m3_m4_n2_grid_desc.GetElementSpaceSize(), c_s_m0_n0_m1_n1_m2_m3_m4_n2_grid_desc.GetElementSize());
    ...
    const auto kernel = kernel_batched_gemm_xdlops_v2r3<GridwiseBatchedGemm,
                                                        FloatAB,
                                                        FloatC,

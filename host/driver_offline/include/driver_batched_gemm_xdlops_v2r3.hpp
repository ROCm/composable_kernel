...

{
    ...
    DeviceMem c_s_m0_n0_m1_n1_m2_m3_m4_n2_grid_desc_dev_buf(sizeof(CGridDesc_B_M0_N0_M1_N1_M2_M3_M4_N2));
    ...
    c_s_m0_n0_m1_n1_m2_m3_m4_n2_grid_desc_dev_buf.ToDevice(&c_grid_desc_b_m0_n0_m1_n1_m2_m3_m4_n2);
...
__host__ float driver_batched_gemm_xdlops_v2r3(const FloatAB* p_a_grid,
                                               const FloatAB* p_b_grid,
                                               FloatC* p_c_grid,
                                               const ck::index_t num_batches,
                                               const ck::index_t a_batch_stride,
                                               const ck::index_t c_batch_stride,
...

{
    ...
    using GridwiseBatchedGemm =
        GridwiseBatchedGemm_k0mk1_k0nk1_mn_xdlops_v2r3<BlockSize,
                                                       FloatAB,
                                                       FloatAcc,
                                                       FloatC,
                                                       CGlobalMemoryDataOperation,
    ...
    const auto c_grid_desc_m0_n0_m1_n1_m2_m3_m4_n2 =
        GridwiseBatchedGemm::MakeCM0N0M1N1M2M3M4N2GridDescriptor(c_grid_desc_m_n);

    using CGridDesc_M0_N0_M1_N1_M2_M3_M4_N2 = decltype(c_grid_desc_m0_n0_m1_n1_m2_m3_m4_n2);

    const auto block_2_ctile_map =
        GridwiseBatchedGemm::MakeBlock2CTileMap(c_grid_desc_m_n, M01, N01);

    using Block2CTileMap = decltype(block_2_ctile_map);

    const index_t grid_size = GridwiseBatchedGemm::CalculateGridSize(c_grid_desc_m_n);
    ...
    {
        const auto kernel =
            kernel_batched_gemm_xdlops_v2r3_ver2<GridwiseBatchedGemm,
                                                 FloatAB,
                                                 FloatC,
...
#elif CK_EXPERIMENTAL_PASS_TENSOR_DESCRIPTOR_BY_VOID_POINTER
    DeviceMem a_grid_desc_k0_m_k1_dev_buf(sizeof(AGridDesc_K0_M_K1) * num_batches);
    DeviceMem b_grid_desc_k0_n_k1_dev_buf(sizeof(BGridDesc_K0_N_K1));
    DeviceMem c_grid_desc_m0_n0_m1_n1_m2_m3_m4_n2_dev_buf(sizeof(CGridDesc_M0_N0_M1_N1_M2_M3_M4_N2) * num_batches);
    DeviceMem block_2_ctile_map_dev_buf(sizeof(Block2CTileMap));

    a_grid_desc_k0_m_k1_dev_buf.ToDevice(&a_grid_desc_k0_m_k1);
    b_grid_desc_k0_n_k1_dev_buf.ToDevice(&b_grid_desc_k0_n_k1);
    c_grid_desc_m0_n0_m1_n1_m2_m3_m4_n2_dev_buf.ToDevice(&c_grid_desc_m0_n0_m1_n1_m2_m3_m4_n2);
    block_2_ctile_map_dev_buf.ToDevice(&block_2_ctile_map);
    ...
    float ave_time = launch_and_time_kernel(
        ...
        cast_pointer_to_constant_address_space(b_grid_desc_k0_n_k1_dev_buf.GetDeviceBuffer()),
        cast_pointer_to_constant_address_space(
            c_grid_desc_m0_n0_m1_n1_m2_m3_m4_n2_dev_buf.GetDeviceBuffer()),
        cast_pointer_to_constant_address_space(block_2_ctile_map_dev_buf.GetDeviceBuffer()));
#endif
    return ave_time;
}

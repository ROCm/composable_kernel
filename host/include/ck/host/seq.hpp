...
constexpr auto sequence_pop_front(Sequence<I, Is...>);

template <typename Seq>
constexpr auto sequence_pop_back(Seq);
...
struct Sequence
{
    ...
    static constexpr auto Size() { return Number<mSize>{}; }

    static constexpr auto GetSize() { return Size(); }
    ...
    template <index_t I>
    static constexpr auto At(Number<I>)
    {
    ...
    template <index_t I>
    static constexpr auto Get(Number<I>)
    {
        return At(Number<I>{});
    }
    ...
    static constexpr auto ReorderGivenNew2Old(Sequence<IRs...> /*new2old*/)
    {
    ...
    static constexpr auto ReorderGivenOld2New(MapOld2New)
    {
    ...
    static constexpr auto Reverse() { return typename sequence_reverse<Type>::type{}; }
    ...
    static constexpr auto PopFront() { return sequence_pop_front(Type{}); }

    static constexpr auto PopBack() { return sequence_pop_back(Type{}); }

    template <index_t... Xs>
    static constexpr auto PushFront(Sequence<Xs...>)
    {
        return Sequence<Xs..., Is...>{};
    }

    template <index_t... Xs>
    static constexpr auto PushFront(Number<Xs>...)
    {
        return Sequence<Xs..., Is...>{};
    }

    template <index_t... Xs>
    static constexpr auto PushBack(Sequence<Xs...>)
    {
        return Sequence<Is..., Xs...>{};
    }

    template <index_t... Xs>
    static constexpr auto PushBack(Number<Xs>...)
    {
        return Sequence<Is..., Xs...>{};
    }

    template <index_t... Ns>
    static constexpr auto Extract(Number<Ns>...)
    {
        return Sequence<Type::At(Number<Ns>{})...>{};
    }

    template <index_t... Ns>
    static constexpr auto Extract(Sequence<Ns...>)
    {
        return Sequence<Type::At(Number<Ns>{})...>{};
    }

    template <index_t I, index_t X>
    static constexpr auto Modify(Number<I>, Number<X>)
    {
...
constexpr auto generate_sequence(F, Number<N>)
{
...
struct arithmetic_sequence_gen
{
    struct F
    {
        constexpr index_t operator()(index_t i) const { return i * Increment + IBegin; }
    };
...
struct uniform_sequence_gen
{
    struct F
    {
        constexpr index_t operator()(index_t) const { return I; }
    };
...
template <index_t... Xs, index_t... Ys>
constexpr bool operator==(Sequence<Xs...>, Sequence<Ys...>)
{
    return ((Xs == Ys) && ...);
}

template <index_t... Xs, index_t... Ys>
constexpr auto operator+(Sequence<Xs...>, Sequence<Ys...>)
{
...
constexpr auto operator+(Sequence<Xs...>, Number<Y>)
{
...
constexpr auto operator+(Number<Y>, Sequence<Xs...>)
{
...
constexpr auto merge_sequences(Seqs...)
{
    return typename sequence_merge<Seqs...>::type{};
}

template <typename F, index_t... Xs>
constexpr auto transform_sequences(F f, Sequence<Xs...>)
{
    return Sequence<f(Xs)...>{};
}

template <typename F, index_t... Xs, index_t... Ys>
constexpr auto transform_sequences(F f, Sequence<Xs...>, Sequence<Ys...>)
{
...
constexpr auto transform_sequences(F f, Sequence<Xs...>, Sequence<Ys...>, Sequence<Zs...>)
{
...
constexpr auto reverse_inclusive_scan_sequence(Seq, Reduce, Number<Init>)
{
    return typename sequence_reverse_inclusive_scan<Seq, Reduce, Init>::type{};
}

template <typename Seq, typename Reduce, index_t Init>
constexpr auto reverse_exclusive_scan_sequence(Seq, Reduce, Number<Init>)
{
...
template <typename Seq, typename Reduce, index_t Init>
constexpr auto inclusive_scan_sequence(Seq, Reduce, Number<Init>)
{
    return reverse_inclusive_scan_sequence(Seq{}.Reverse(), Reduce{}, Number<Init>{}).Reverse();
}

template <typename Seq, index_t... Is>
constexpr auto pick_sequence_elements_by_ids(Seq, Sequence<Is...> /* ids */)
{
...
constexpr auto pick_sequence_elements_by_mask(Seq, Mask)
{
...
constexpr auto modify_sequence_elements_by_ids(Seq, Values, Ids)
{
...
template <typename Seq, typename Reduce, index_t Init>
constexpr index_t reduce_on_sequence(Seq, Reduce f, Number<Init> /*initial_value*/)
{
    index_t result = Init;
...
constexpr bool sequence_any_of(Seq, F f)
{
    bool flag = false;
...
template <typename Seq, typename F>
constexpr bool sequence_all_of(Seq, F f)
{
    bool flag = true;

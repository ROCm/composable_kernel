...
// Naive GPU reference for backward data grouped convolution
...
__global__ void naive_grouped_conv_bwd_data_kernel(InDataType* __restrict__ p_in_grad,
                    ...
                    if(w_tmp % conv_strides[0] == 0)
                    {
                        ...
                        if(wo >= 0 && wo < out_spatial_lengths[0])
                        {
                            ...
                            ck_tile::long_index_t wei_idx = g * wei_strides[0] +
                                                            k * wei_strides[1] + c * wei_strides[2] +
                                                            x * wei_strides[2];
                                ...
                                if(w_tmp % conv_strides[1] == 0)
                                {
                                    ...
                                    if(wo >= 0 && wo < out_spatial_lengths[1])
                                    {
                                        ...
                                        ck_tile::long_index_t wei_idx =
                                            ...
                                            c * wei_strides[2] + y * wei_strides[3] +
                                            x * wei_strides[4];
                            ...
                            for(ck_tile::index_t y = 0; y < wei_spatial_lengths[1]; ++y)
                            {
                                ...
                                if(h_tmp % conv_strides[1] == 0)
                                {
                                    ...
                                    if(ho >= 0 && ho < out_spatial_lengths[1])
                                    {
                                        ...
                                        {
                                            ck_tile::long_index_t w_tmp =
                                                static_cast<ck_tile::long_index_t>(in_spatial_idx[2]) +
                                            ...
                                            {
                                                ck_tile::long_index_t wo = w_tmp / conv_strides[2];
                                                ...
                                                if(wo >= 0 && wo < out_spatial_lengths[2])
                                                {
                                                    ...
                                                    ck_tile::long_index_t wei_idx =
                                                        g * wei_strides[0] + k * wei_strides[1] +
                                                        c * wei_strides[2] + z * wei_strides[3] +
                                                        y * wei_strides[4] + x * wei_strides[5];
...
template <ck_tile::index_t NDimSpatial,
          ...
          typename WeiDataType,
          typename OutDataType>
CK_TILE_HOST float naive_grouped_conv_bwd_data(InDataType* p_in_grad_dev,

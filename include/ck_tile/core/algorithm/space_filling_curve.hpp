...
struct space_filling_curve
{
    static constexpr index_t TensorSize =
        reduce_on_sequence(TensorLengths{}, multiplies<void, void>{}, number<1>{});
    ...
    static constexpr index_t ScalarPerVector =
        reduce_on_sequence(ScalarsPerAccess{}, multiplies<void, void>{}, number<1>{});
    ...
    CK_TILE_HOST_DEVICE static constexpr index_t get_num_of_access()
    {
        ...
        return reduce_on_sequence(TensorLengths{}, multiplies<void, void>{}, number<1>{}) / ScalarPerVector;
    }
    ...
    static CK_TILE_HOST_DEVICE constexpr Index _get_index(number<AccessIdx1d>)
    {
        ...
        constexpr auto access_strides =
            container_reverse_exclusive_scan(ordered_access_lengths, multiplies<void, void>{}, number<1>{});

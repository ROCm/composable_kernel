...
struct static_uford_one_shot_impl
{
    ...
    CK_TILE_HOST_DEVICE constexpr void operator()(F f, CurrentUnpackIds, number<current_acc>) const
    {
        constexpr auto r_lens_stride =
            reverse_exclusive_scan_sequence(RemainLengths{}, multiplies<void, void>{}, number<1>{});
        constexpr auto r_upks_stride =
            reverse_exclusive_scan_sequence(RamainUnpacks{}, multiplies<void, void>{}, number<1>{});
...
struct static_uford
{
    static constexpr index_t num_packs = reduce_on_sequence(Unpacks{}, multiplies<void, void>{}, number<1>{});
    ...
    CK_TILE_HOST_DEVICE static constexpr index_t get_num_of_access()
    {
        ...
        return reduce_on_sequence(L_{}, multiplies<void, void>{}, number<1>{});
    }

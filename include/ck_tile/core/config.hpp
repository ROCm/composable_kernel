...
// workaround for ROCm 6.3 and later
#ifndef CK_TILE_WORKAROUND_ROCM_6_3_SCRATCH_MEMORY_ISSUE
#if(HIP_VERSION_MAJOR == 6 && HIP_VERSION_MINOR == 3 && HIP_VERSION_PATCH >= 42131) || \
    (HIP_VERSION_MAJOR == 6 && HIP_VERSION_MINOR > 3)
#define CK_TILE_WORKAROUND_ROCM_6_3_SCRATCH_MEMORY_ISSUE 1
#else
#define CK_TILE_WORKAROUND_ROCM_6_3_SCRATCH_MEMORY_ISSUE 0
#endif
#endif
...
#if !defined(CK_TILE_BUFFER_LOAD_RAW_FP16_WA) || CK_TILE_WORKAROUND_ROCM_6_3_SCRATCH_MEMORY_ISSUE
#define CK_TILE_BUFFER_LOAD_RAW_FP16_WA 1
#else
#define CK_TILE_BUFFER_LOAD_RAW_FP16_WA 0
#endif

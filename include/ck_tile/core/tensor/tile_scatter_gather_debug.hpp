...
struct tile_scatter_gather_debug
{
    ...
    struct load_store_traits
    {
        ...
        static constexpr auto get_vector_dim_y_scalar_per_vector()
        {
            const auto [ys_vector_lengths, ys_vector_strides] =
                tile_scatter_gather_debug::get_window_adaptor_ys_safe_vector_length_strides();
    ...
    CK_TILE_DEVICE constexpr tile_scatter_gather_debug() = default;

    CK_TILE_DEVICE constexpr tile_scatter_gather_debug(const BottomTensorView& bottom_tensor_view,
          ...
          pre_computed_coords_{}
    {
      ...
      // only support warp-tile and block-tile
        ...
        bottom_tensor_thread_origin_idx_tmp(HsGatherDim) = bottom_tensor_thread_origin_idx_tmp[HsGatherDim] % HsPagesize;
...
make_tile_scatter_gather_debug(const TensorView_& tensor_view,
                         ...
                         number<NumCoord>    = {})
{
    return tile_scatter_gather_debug<remove_cvref_t<TensorView_>,
...
template <typename TensorView,
          ...
          index_t HsGatherDim>
CK_TILE_DEVICE constexpr auto make_tile_scatter_gather_debug(
    ...
    number<HsGatherDim> = {})
{
    return make_tile_scatter_gather_debug(tile_window.get_bottom_tensor_view(),

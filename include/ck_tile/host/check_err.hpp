...
CK_TILE_HOST double get_relative_threshold(const int number_of_accumulations = 1)
{
    ...
    static_assert(
        is_any_of<ComputeDataType, F8, BF8, F16, BF16, F32, pk_int4_t, pk_fp4_t, I8, I32, uint8_t,int>::value,
                                           ...
                                           const int number_of_accumulations = 1)
{
    ...
    static_assert(
        is_any_of<ComputeDataType, F8, BF8, F16, BF16, F32, pk_int4_t, I8, I32, uint8_t, int>::value,

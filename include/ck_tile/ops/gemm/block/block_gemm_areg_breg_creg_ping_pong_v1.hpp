...
struct BlockGemmARegBRegCRegPingPongV1
{
    private:
    ...
    struct GemmTraits_
    {
        ...
        static constexpr index_t KWarp = config.template at<3>();
    ...
    {
        constexpr auto ping_pong_dstr_encoding =
        ...
        constexpr auto a_block_dstr_encode = detail::make_embed_tile_distribution_encoding(
            ping_pong_dstr_encoding, typename WarpGemm::AWarpDstrEncoding{});

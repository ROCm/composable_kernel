...
struct BlockUniversalGemmAsBsCr
{
    ...
    struct BlockGemmImpl<GemmPipelineScheduler::Interwave, GemmTraits>
    {
                                          ...
                                          bool_constant<BLoadTranspose> = {})
        {
            ...
            load_int4_tile<ADataType, ATypeToUse, UnaryOpSize_, ALoadTranspose>(a_warp_tile_, a_lds_gemm_window);
            load_int4_tile<BDataType, BTypeToUse, UnaryOpSize_, BLoadTranspose>(b_warp_tile_, b_lds_gemm_window);
        }

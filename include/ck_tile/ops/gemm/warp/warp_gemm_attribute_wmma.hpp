...
template <typename Impl, bool TransLdA>
struct AWarpDstrEncodingTrait;

template <typename Impl, bool TransLdB>
struct BWarpDstrEncodingTrait;

template <typename Impl, bool kTransC>
struct CWarpDstrEncodingTrait;

template <typename Impl>
struct AWarpDstrEncodingTrait<Impl, false>
{
...
template <typename Impl>
struct AWarpDstrEncodingTrait<Impl, true>
{
    using type = tile_distribution_encoding<sequence<1>,
...
template <typename Impl>
struct BWarpDstrEncodingTrait<Impl, false>
{
    using type = tile_distribution_encoding<
        sequence<Impl::kRepeat>,
...
template <typename Impl>
struct BWarpDstrEncodingTrait<Impl, true>
{
    using type = tile_distribution_encoding<sequence<1>,
                                            tuple<sequence<4, 4>, sequence<2, 8>>,
                                            tuple<sequence<1, 2, 1>>,
...
template <typename Impl>
struct CWarpDstrEncodingTrait<Impl, true>
{
    using type = tile_distribution_encoding<
        sequence<>,
        tuple<sequence<Impl::kCNLane>,
              sequence<Impl::kCM0PerLane, Impl::kCMLane, Impl::kCM1PerLane>>,
        tuple<typename Impl::kCPs2RHssTransMajor>,
        tuple<typename Impl::kCPs2RHssTransMinor>,
        typename Impl::kCYs2RHsTransMajor,
        typename Impl::kCYs2RHsTransMinor>;
};

template <typename Impl>
struct CWarpDstrEncodingTrait<Impl, false>
{
    using type = tile_distribution_encoding<
        sequence<>,
...
struct WarpGemmAtrributeWmma
{
    ...
    using AWarpDstrEncoding = typename AWarpDstrEncodingTrait<Impl, kTransLdA>::type;
    using BWarpDstrEncoding = typename BWarpDstrEncodingTrait<Impl, kTransLdB>::type;
    ...
    using CWarpDstrEncoding = typename CWarpDstrEncodingTrait<Impl, kTransC>::type;

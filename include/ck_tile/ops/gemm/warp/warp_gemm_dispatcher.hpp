...
template<> struct WarpGemmMfmaDispatcher<ck_tile::fp8_t, ck_tile::fp8_t, float, 32, 32,  8, false> { using Type = WarpGemmMfma_f32_32x32x16_fp8_fp8; }; // bogus type, but needed for some tests
...
template<> struct WarpGemmMfmaDispatcher<ck_tile::bf8_t, ck_tile::bf8_t, float, 32, 32,  8, false> { using Type = WarpGemmMfma_f32_32x32x16_bf8_bf8; }; // bogus type, but needed for some tests

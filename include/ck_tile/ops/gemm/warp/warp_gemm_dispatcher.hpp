...
template<> struct WarpGemmMfmaDispatcher<ck_tile::fp8_t, ck_tile::fp8_t, float, 32, 32,  8, false> { using Type = WarpGemmMfma_f32_32x32x8_fp8_fp8; }; // unsupported, but needed for compiling gemm_universal
...
template<> struct WarpGemmMfmaDispatcher<ck_tile::bf8_t, ck_tile::bf8_t, float, 32, 32,  8, false> { using Type = WarpGemmMfma_f32_32x32x8_bf8_bf8; }; // unsupported, but needed for some compiling gemm_universal

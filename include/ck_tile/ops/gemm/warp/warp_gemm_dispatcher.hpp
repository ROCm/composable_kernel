...
template<> struct WarpGemmMfmaDispatcher<ck_tile::half_t, ck_tile::half_t, float, 4, 64, 16, true> { using Type = WarpGemmMfmaF16F16F32M4N64K16TransposedCDistribution; };
...
template<> struct WarpGemmMfmaDispatcher<ck_tile::half_t, ck_tile::half_t, float, 64, 4, 16, true> { using Type = WarpGemmMfmaF16F16F32M64N4K16TransposedCDistribution; };
...
template<> struct WarpGemmMfmaDispatcher<ck_tile:;bf16_t, ck_tile::bf16_t, float, 4, 64, 16, true> { using Type = WarpGemmMfmaBf16Bf16F32M4N64K16TransposedCDistribution; };
...
template<> struct WarpGemmMfmaDispatcher<ck_tile:;bf16_t, ck_tile::bf16_t, float, 64, 4, 16, true> { using Type = WarpGemmMfmaBf16Bf16F32M64N4K16TransposedCDistribution; };

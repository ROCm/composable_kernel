...
struct FmhaBspFwdKernel
{
    ...
    static constexpr ck_tile::index_t kBlockSize  = FmhaBspPipeline::kBlockSize;
    static constexpr ck_tile::index_t kBlockPerCu = FmhaBspPipeline::kBlockPerCu;
    ...
    using BiasDataType = ck_tile::remove_cvref_t<typename FmhaBspPipeline::BiasDataType>;
    using RandValOutputDataType =
        ck_tile::remove_cvref_t<typename FmhaBspPipeline::RandValOutputDataType>;
    using LSEDataType  = ck_tile::remove_cvref_t<typename FmhaBspPipeline::LSEDataType>;
    using ODataType    = ck_tile::remove_cvref_t<typename FmhaBspPipeline::ODataType>;
    using SaccDataType = ck_tile::remove_cvref_t<typename FmhaBspPipeline::SaccDataType>;

    using VLayout = ck_tile::remove_cvref_t<typename FmhaBspPipeline::VLayout>;

    static constexpr bool kIsGroupMode      = FmhaBspPipeline::kIsGroupMode;
    static constexpr bool kPadSeqLenQ       = FmhaBspPipeline::kPadSeqLenQ;
    static constexpr bool kPadSeqLenK       = FmhaBspPipeline::kPadSeqLenK;
    static constexpr bool kPadHeadDimQ      = FmhaBspPipeline::kPadHeadDimQ;
    static constexpr bool kPadHeadDimV      = FmhaBspPipeline::kPadHeadDimV;
    static constexpr auto BiasEnum          = FmhaBspPipeline::BiasEnum;
    static constexpr bool kStoreLSE         = FmhaBspPipeline::kStoreLSE;
    static constexpr bool kHasDropout       = FmhaBspPipeline::kHasDropout;
    static constexpr bool kDoFp8StaticQuant = FmhaBspPipeline::Problem::kDoFp8StaticQuant;
    using FmhaMask                 = ck_tile::remove_cvref_t<typename FmhaBspPipeline::FmhaMask>;
    static constexpr bool kHasMask = FmhaMask::IsMasking;

    static constexpr bool kUseAsyncCopy = FmhaBspPipeline::Policy::AsyncCopy;
    ...
    CK_TILE_HOST static std::string GetName()
    {
        ...
        // clang-format off
        using bfs = typename FmhaBspPipeline::BlockFmhaShape;
        ...
        std::cout << "kernel name: " << _SS_("fmha_fwd_d") + _TS_(bfs::kQKHeaddim) + "_" + _SS_(t2s<QDataType>::name) +
            ...
            (kBlockPerCuInput == -1 ? "" : ("o" + _TS_(kBlockPerCu) + "_")) + _SS_(FmhaBspPipeline::name) + "_" +
            ...
            (kHasMask ? "_" + _SS_(FmhaMask::name) : "_nmask") + (kStoreLSE ? "_lse" : "_nlse" ) + (kHasDropout ? "_dropout" : "_ndropout" ) + (kDoFp8StaticQuant ? "_squant" : "_nsquant" ) << std::endl;
        return
    ...
    struct FmhaBspFwdCommonBiasKargs
    {
    ...
    struct FmhaBspFwdBatchModeBiasKargs : FmhaBspFwdCommonBiasKargs
    {
        ck_tile::index_t batch_stride_bias = 0;
    };

    struct FmhaBspFwdAlibiKargs
    {
    ...
    struct FmhaBspFwdFp8StaticQuantKargs
    {
        float scale_p;
        float scale_o;
    };

    struct FmhaBspFwdCommonLSEKargs
    {
    ...
    struct FmhaBspFwdDropoutSeedOffset
    {
        template <typename T>
    ...
    struct FmhaBspFwdCommonDropoutKargs : FmhaBspFwdDropoutSeedOffset
    {
    ...
    struct FmhaBspFwdBatchModeDropoutKargs : FmhaBspFwdCommonDropoutKargs
    {
        ck_tile::index_t batch_stride_randval = 0;
    };

    struct FmhaBspFwdBatchModeKargs
        : FmhaBspFwdCommonKargs,
          std::conditional_t<BiasEnum == BlockAttentionBiasEnum::ELEMENTWISE_BIAS,
                             FmhaBspFwdBatchModeBiasKargs,
                             std::conditional_t<BiasEnum == BlockAttentionBiasEnum::ALIBI,
                                                FmhaBspFwdAlibiKargs,
                                                FmhaBspFwdEmptyKargs<0>>>,
          std::conditional_t<kHasMask, FmhaBspFwdMaskKargs, FmhaBspFwdEmptyKargs<1>>,
          std::conditional_t<kStoreLSE, FmhaBspFwdCommonLSEKargs, FmhaBspFwdEmptyKargs<2>>,
          std::conditional_t<kDoFp8StaticQuant, FmhaBspFwdFp8StaticQuantKargs, FmhaBspFwdEmptyKargs<3>>,
          std::conditional_t<kHasDropout, FmhaBspFwdBatchModeDropoutKargs, FmhaBspFwdEmptyKargs<4>>
    {
    ...
    struct FmhaBspFwdGroupModeKargs
        : FmhaBspFwdCommonKargs,
          std::conditional_t<BiasEnum == BlockAttentionBiasEnum::ELEMENTWISE_BIAS,
                             FmhaBspFwdCommonBiasKargs,
                             std::conditional_t<BiasEnum == BlockAttentionBiasEnum::ALIBI,
                                                FmhaBspFwdAlibiKargs,
                                                FmhaBspFwdEmptyKargs<0>>>,
          std::conditional_t<kHasMask, FmhaBspFwdMaskKargs, FmhaBspFwdEmptyKargs<1>>,
          std::conditional_t<kStoreLSE, FmhaBspFwdCommonLSEKargs, FmhaBspFwdEmptyKargs<2>>,
          std::conditional_t<kDoFp8StaticQuant, FmhaBspFwdFp8StaticQuantKargs, FmhaBspFwdEmptyKargs<3>>,
          std::conditional_t<kHasDropout, FmhaBspFwdCommonDropoutKargs, FmhaBspFwdEmptyKargs<4>>
    {
    ...
    using Kargs = std::conditional_t<kIsGroupMode, FmhaBspFwdGroupModeKargs, FmhaBspFwdBatchModeKargs>;
                                                ...
                                                bool has_padded_seqlen_k = false)
    {
        ...
        if(has_padded_seqlen_k)
        {
            ...
            return dim3(nhead_,
                        batch_size_,
                        ck_tile::integer_divide_ceil(seqlen_q_, FmhaBspPipeline::kM0) *
                            ck_tile::integer_divide_ceil(hdim_v_, FmhaBspPipeline::kN1));
        }
        else
        {
            // TODO: this may need tuning
            return dim3(ck_tile::integer_divide_ceil(seqlen_q_, FmhaBspPipeline::kM0) *
                            ck_tile::integer_divide_ceil(hdim_v_, FmhaBspPipeline::kN1),
                        nhead_,
                        batch_size_);
        }
    ...
    CK_TILE_DEVICE static constexpr auto GetTileIndex(const Kargs& kargs)
    {
        ...
        if(has_padded_seqlen_k)
        {
            ...
            const index_t num_tile_n1 =
                ck_tile::integer_divide_ceil(kargs.hdim_v, FmhaBspPipeline::kN1);
    ...
    {
        return ck_tile::max(FmhaBspPipeline::GetSmemSize(), EpiloguePipeline::GetSmemSize());
    }
    ...
    CK_TILE_DEVICE void operator()(Kargs kargs) const
    {
        ...
        const index_t i_m0 = __builtin_amdgcn_readfirstlane(i_tile_m * FmhaBspPipeline::kM0);
        const index_t i_n1 = __builtin_amdgcn_readfirstlane(i_tile_n * FmhaBspPipeline::kN1);
        ...
        const auto q_dram = [&]() {
            const auto q_dram_naive = make_naive_tensor_view<address_space_enum::global>(
                ...
                number<FmhaBspPipeline::kAlignmentQ>{},
                number<1>{});
            if constexpr(FmhaBspPipeline::kQLoadOnce)
            {
                return pad_tensor_view(
                    q_dram_naive,
                    make_tuple(number<FmhaBspPipeline::kM0>{}, number<FmhaBspPipeline::kSubQKHeaddim>{}),
            ...
            else
            {
                return pad_tensor_view(
                    q_dram_naive,
                    make_tuple(number<FmhaBspPipeline::kM0>{}, number<FmhaBspPipeline::kK0>{}),
                    sequence<kPadSeqLenQ, kPadHeadDimQ>{});
            }
        }();
        const auto k_dram = [&]() {
            const auto k_dram_naive = make_naive_tensor_view<address_space_enum::global>(
                ...
                number<FmhaBspPipeline::kAlignmentK>{},
                number<1>{});

            constexpr bool kPadSeqLenK_ = kUseAsyncCopy ? kPadSeqLenK : false;
            return pad_tensor_view(
                k_dram_naive,
                make_tuple(number<FmhaBspPipeline::kN0>{}, number<FmhaBspPipeline::kK0>{}),
        ...
        const auto v_dram = [&]() {
            if constexpr(std::is_same_v<VLayout, ck_tile::tensor_layout::gemm::RowMajor>)
            {
                const auto v_dram_naive = make_naive_tensor_view<address_space_enum::global>(
                    ...
                    number<FmhaBspPipeline::kAlignmentV>{},
                    number<1>{});
        ...
        auto q_dram_window = make_tile_window(
            ...
            [&]() {
                if constexpr(FmhaBspPipeline::kQLoadOnce)
                    return make_tuple(number<FmhaBspPipeline::kM0>{},
                                      number<FmhaBspPipeline::kSubQKHeaddim>{});
                else
                    return make_tuple(number<FmhaBspPipeline::kM0>{}, number<FmhaBspPipeline::kK0>{});
            }(),
            {i_m0, 0});

        auto k_dram_window = make_tile_window(
            k_dram, make_tuple(number<FmhaBspPipeline::kN0>{}, number<FmhaBspPipeline::kK0>{}), {0, 0});
        ...
        const auto bias_dram_window = [&, i_nhead_ = i_nhead]() {
            constexpr auto bias_dram_window_lengths =
                make_tuple(number<FmhaBspPipeline::kM0>{}, number<FmhaBspPipeline::kN0>{});
            if constexpr(BiasEnum == BlockAttentionBiasEnum::ELEMENTWISE_BIAS)
            {
                ...
                const auto bias_dram = [&]() {
                    const auto bias_dram_naive = make_naive_tensor_view<address_space_enum::global>(
                        ...
                        number<FmhaBspPipeline::kAlignmentBias>{},
                        number<1>{});
        ...
        auto lse_dram_window = [&, i_nhead_ = i_nhead]() {
            constexpr auto lse_dram_window_lengths = make_tuple(number<FmhaBspPipeline::kM0>{});
            if constexpr(kStoreLSE)
            {
                LSEDataType* lse_ptr =
        ...
        auto o_dram = [&]() {
            const auto o_dram_naive = make_naive_tensor_view<address_space_enum::global>(
                ...
                number<FmhaBspPipeline::kAlignmentO>{},
                number<1>{});

            return pad_tensor_view(
                o_dram_naive,
                make_tuple(number<FmhaBspPipeline::kM0>{}, number<FmhaBspPipeline::kN1>{}),

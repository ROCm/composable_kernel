...
struct TileFmhaShape
{
    ...
    static constexpr index_t NumGemm0Warps =
        reduce_on_sequence(Gemm0BlockWarps{}, multiplies<void, void>{}, number<1>{});
    static constexpr index_t NumGemm1Warps =
        reduce_on_sequence(Gemm1BlockWarps{}, multiplies<void, void>{}, number<1>{});
...
struct TileFmhaBwdShape
{
    ...
    static_assert(NumWarps == reduce_on_sequence(Gemm1BlockWarps{}, multiplies<void, void>{}, number<1>{}) &&
                  NumWarps == reduce_on_sequence(Gemm4BlockWarps{}, multiplies<void, void>{}, number<1>{}));

...
#include "ck_tile/ops/fmha/pipeline/block_fmha_pipeline_qr_ks_vs_async_v2_default_policy.hpp"
...
template <typename Problem_, typename Policy_ = BlockFmhaPipelineQRKSVSAsyncV2DefaultPolicy>
struct BlockFmhaPipelineQRKSVSAsyncV2
{
    ...
    static constexpr const char* name = "qr_async_v2";

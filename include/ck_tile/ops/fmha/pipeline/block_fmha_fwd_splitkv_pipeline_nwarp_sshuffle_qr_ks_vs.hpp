...
struct BlockFmhaFwdSplitKVPipelineNWarpSShuffleQRKSVS
{
               ...
               void* smem_ptr) const
    {
        ...
        do
        {
            ...
            static_for<0, k0_loops, 1>{}([&, &v_dram_window_ = v_dram_window](auto i_k0) {
            ...
            // STAGE 3, KV gemm
            static_for<0, k1_loops, 1>{}([&, &v_dram_window_ = v_dram_window](auto i_k1) {
            ...
            {
                i_page_block_v =
                    v_page_block_navigator.move_tile_window(i_page_block_v, v_dram_window, {0, 0});
            };

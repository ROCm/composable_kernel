        ...
        FmhaDropout& dropout) const
    {
        ...
        auto restrict_body = [&](KDataType* __restrict__ k_lds_ptr,
            ...
            /*
                    ...
                    const auto do_lds_ptr0 = reinterpret_cast<OGradDataType*
               __restrict__>(smem_ptr_); const auto do_lds_ptr1 = reinterpret_cast<OGradDataType*
               __restrict__>( smem_ptr_ + Policy::template GetSmemSizeOGrad<Problem>()); const auto
               q_lds_ptr0 = reinterpret_cast<QDataType* __restrict__>( smem_ptr_ + Policy::template
               GetSmemSizeOGrad<Problem>() + Policy::template GetSmemSizeOGrad<Problem>()); const
               auto q_lds_ptr1 = reinterpret_cast<QDataType* __restrict__>( smem_ptr_ +
               Policy::template GetSmemSizeOGrad<Problem>() + Policy::template
               GetSmemSizeOGrad<Problem>() + Policy::template GetSmemSizeQ<Problem>()); const auto
               lse_lds_ptr = reinterpret_cast<LSEDataType* __restrict__>( smem_ptr_ +
               Policy::template GetSmemSizeOGrad<Problem>() + Policy::template
               GetSmemSizeOGrad<Problem>() + Policy::template GetSmemSizeQ<Problem>() +
               Policy::template GetSmemSizeQ<Problem>()); const auto d_lds_ptr =
               reinterpret_cast<DDataType* __restrict__>( smem_ptr_ + Policy::template
               GetSmemSizeOGrad<Problem>() + Policy::template GetSmemSizeOGrad<Problem>() +
                        Policy::template GetSmemSizeQ<Problem>() + Policy::template
               GetSmemSizeQ<Problem>() + Policy::template GetSmemSizeLSE<Problem>()); const auto
               ds_lds_ptr = reinterpret_cast<GemmDataType* __restrict__>( smem_ptr_ +
               Policy::template GetSmemSizeOGrad<Problem>() + Policy::template
               GetSmemSizeOGrad<Problem>() + Policy::template GetSmemSizeQ<Problem>() +
               Policy::template GetSmemSizeQ<Problem>() + Policy::template GetSmemSizeLSE<Problem>()
               + Policy::template GetSmemSizeD<Problem>()); const auto bias_lds_ptr =
               reinterpret_cast<BiasDataType* __restrict__>(ds_lds_ptr);
            */
            ...
            auto randval_dram_window =
                dropout.template MakeRandvalDramWindow<decltype(gemm_0), false>(
            ...
            auto main_body_impl   = [&](auto is_prologue_,
                ...
                static_assert(is_prologue || is_epilogue,
                              "is_prologue or is_epilogue should be true");
                ...
                if constexpr(is_epilogue)
                {
...

                    {
                        ...
                        {
                            set_tile_if(
                                s_acc, -numeric<AccDataType>::infinity(), [&](auto tile_idx) {
                                    const auto row = seqlen_q_step + tile_idx.at(number<0>{});
                                    const auto col =
                                        k_origin.at(number<0>{}) + tile_idx.at(number<1>{});
                ...
                if constexpr(is_epilogue)
                {
                    ...
                    static_for<0, k4_loops, 1>{}([&](auto i_k4) {
                        ...
                        if constexpr(i_k4 < k4_loops - 1)
                        {
                            ds_reg_tensor.get_thread_buffer() =
                                ds_reg_tensor_next.get_thread_buffer();
                        }
                    });
                ...
                if constexpr(is_epilogue)
                {
                    ...
                    {
                        tile_elementwise_inout(
                            [&scale_rp_undrop](auto& x) { x = x * scale_rp_undrop; }, dq_acc);
                    }
                    else
                    {
                        tile_elementwise_inout([&raw_scale](auto& x) { x = x * raw_scale; },
                                               dq_acc);
                    }
        ...
        restrict_body(
            reinterpret_cast<KDataType*>(smem_ptr_), // k_lds_ptr
            reinterpret_cast<VDataType*>(smem_ptr_ +
                                         Policy::template GetSmemSizeK<Problem>()), // v_lds_ptr
            reinterpret_cast<OGradDataType*>(smem_ptr_),                            // do_lds_ptr0
            reinterpret_cast<OGradDataType*>(
                smem_ptr_ + Policy::template GetSmemSizeOGrad<Problem>()), // do_lds_ptr1
            reinterpret_cast<QDataType*>(
            ...
            reinterpret_cast<QDataType*>(smem_ptr_ + Policy::template GetSmemSizeOGrad<Problem>() +
                                         ...
                                         Policy::template GetSmemSizeQ<Problem>()), // q_lds_ptr1
            reinterpret_cast<LSEDataType*>(smem_ptr_ +
                                           Policy::template GetSmemSizeOGrad<Problem>() +
                                           Policy::template GetSmemSizeOGrad<Problem>() +
                                           Policy::template GetSmemSizeQ<Problem>() +
                                           Policy::template GetSmemSizeQ<Problem>()), // lse_lds_ptr
            reinterpret_cast<DDataType*>(smem_ptr_ + Policy::template GetSmemSizeOGrad<Problem>() +
                                         Policy::template GetSmemSizeOGrad<Problem>() +
                                         Policy::template GetSmemSizeQ<Problem>() +
                                         Policy::template GetSmemSizeQ<Problem>() +
                                         Policy::template GetSmemSizeLSE<Problem>()), // d_lds_ptr
            reinterpret_cast<GemmDataType*>(smem_ptr_ +
                                            Policy::template GetSmemSizeOGrad<Problem>() +
                                            Policy::template GetSmemSizeOGrad<Problem>() +
                                            Policy::template GetSmemSizeQ<Problem>() +
                                            Policy::template GetSmemSizeQ<Problem>() +
                                            Policy::template GetSmemSizeLSE<Problem>() +
                                            Policy::template GetSmemSizeD<Problem>()), // ds_ltr_ptr
            reinterpret_cast<BiasDataType*>(
                ...
                Policy::template GetSmemSizeQ<Problem>() +
                Policy::template GetSmemSizeLSE<Problem>() +
                Policy::template GetSmemSizeD<Problem>())); // bias_ltr_ptr

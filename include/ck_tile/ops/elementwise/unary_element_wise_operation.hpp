 ...
 *       the output sequence will be fp16(7, 6, 5, 4, 3, 2, 1, 0). Therefore, the input tensor
...
void permute_vectors_i4x4_b(Tensor& tensor) CK_TILE_DEVICE fp16x4_t i4_to_half4(int q)
{
 ...
 * @note The output ordering differs from input ordering. For example, when input is 0x76543210,
 *       the output sequence will be bf16(7, 6, 5, 4, 3, 2, 1, 0). Therefore, the input tensor
 *       must be preprocessed with permute_vectors_i4x4_b on the host side before using this
 * function.
 *
 * @see permute_vectors_i4x4_b
 ...
 * @note The output ordering differs from input ordering. For example, when input is 0x76543210,
 *       the output sequence will be fp8(7, 6, 5, 4, 3, 2, 1, 0). Therefore, the input tensor
 *       must be preprocessed with permute_vectors_i4x4_b on the host side before using this
 * function.
 *
 * @see permute_vectors_i4x4_b
 ...
 * @note The output ordering differs from input ordering. For example, when input is 0x76543210,
 *       the output sequence will be bf8(7, 6, 5, 4, 3, 2, 1, 0). Therefore, the input tensor
 *       must be preprocessed with permute_vectors_i4x4_b on the host side before using this
 * function.
 *
 * @see permute_vectors_i4x4_b

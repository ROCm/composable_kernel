#ifndef DEVICE_CONV2D_DIRECT_FWD_AVX2_NHWC_KYXCK8_NHWK_HPP
#define DEVICE_CONV2D_DIRECT_FWD_AVX2_NHWC_KYXCK8_NHWK_HPP
...
struct DeviceConvNDDirectFwdAvx2_Input_N_Hi_Wi_C_Weight_K_Y_X_C_K8_Output_N_Ho_Wo_K
    : public DeviceConvFwd<InElementwiseOperation, WeiElementwiseOperation, OutElementwiseOperation>
{
    using DeviceOp = DeviceConvNDDirectFwdAvx2_Input_N_Hi_Wi_C_Weight_K_Y_X_C_K8_Output_N_Ho_Wo_K;
    ...
    using GridwiseGemm =
        ck::cpu::GridwiseDirectConvNHWCAvx2<InDataType,              // InDataType,

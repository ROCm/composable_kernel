                ...
                auto LoopFunc = [&](auto scale_comp_buf, auto scale_mem_buf) {
                    ...
                    static_for<0, MRepeat, 1>{}([&](auto m0) {
                        ...
                        static_ford<Sequence<KRepeat, NRepeat>>{}([&](auto kn) {
                            ...
                            vector_type<ComputeTypeB, BKPack> b_thread_vec_up;
                            ...
                            auto loadBUp =
                                thread_buf_to_vec_loader<decltype(b_thread_vec_up),
                                                         decltype(b_thread_bufs_up[scale_comp_buf]),
                                                         decltype(b_thread_desc_),
                                                         ComputeTypeB,
                                                         Number<in_major>,
                                                         Number<0>,
                                                         ...
                                                         Number<k0>,
                                                         index_expression::Ik>{
                                    b_thread_vec_up, b_thread_bufs_up[scale_comp_buf]};

                            static_for<0, KPack, 1>{}(MakeFunctorInvoker(loadA));
                            static_for<0, BKPack, 1>{}(MakeFunctorInvoker(loadB, loadBUp));

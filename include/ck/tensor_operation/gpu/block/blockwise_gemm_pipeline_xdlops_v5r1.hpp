...
template <BlockGemmPipelineScheduler BlkGemmPipelineVer,
          ...
          index_t NRepeat,
          index_t KPacks>
struct BlockwiseGemmXdlops_pipeline_v5r1
{
};
...
template <index_t BlockSize,
          ...
          >
struct BlockwiseGemmXdlops_pipeline_v5r1<BlockGemmPipelineScheduler::Intrawave,
                                         BlockSize,
                                         FloatAB,
                                         FloatAcc,
                                         ATileDesc,
...

{
    ...
    static constexpr index_t HotloopUnroll   = 1;
                        ...
                        index_t num_loop) const
    {
        ...
        auto ReadWriteCompFunc = [&](auto vmem_buf) {
            static_for<0, KRepeat - 1, 1>{}([&](auto k0) {
                ...
                static_for<0, MRepeat, 1>{}([&](auto m0) {
                    a_thread_copy_.Run(a_block_desc_m0_m1_m2_k,
                                       make_tuple(m0, I0, I0, Number<(k0 + 1) * AMmaKStride>{}),
                                       a_block_buf,
                                       a_thread_desc_,
                                       make_tuple(m0, I0, I0, I0),
                                       a_thread_buf);
                ...
                static_for<0, NRepeat, 1>{}([&](auto n0) {
                    b_thread_copy_.Run(b_block_desc_n0_n1_n2_k,
                                       make_tuple(n0, I0, I0, Number<(k0 + 1) * BMmaKStride>{}),
                                       b_block_buf,
                                       b_thread_desc_,
                                       make_tuple(n0, I0, I0, I0),
                                       b_thread_buf);

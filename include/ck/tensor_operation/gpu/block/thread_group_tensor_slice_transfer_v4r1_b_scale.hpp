...
struct ThreadGroupTensorSliceTransfer_v4r1_b_scale
{
    ...
    __device__ constexpr ThreadGroupTensorSliceTransfer_v4r1_b_scale(
    ...
    using ThreadwiseTransfer =
        ThreadwiseTensorSliceTransfer_v3r1_b_scale<decltype(thread_slice_lengths),

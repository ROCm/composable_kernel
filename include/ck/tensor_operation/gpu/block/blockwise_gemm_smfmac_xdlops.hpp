...
struct BlockwiseGemmXdlops_k0mk1_k0nk1_m0n0m1n1m2m3m4n2_v1
{
                        ...
                        CThreadBuffer& c_thread_buf) const
    {
        ...
        static_for<0, MRepeat, 1>{}([&](auto m0) {
            ...
            SetIdxSqueezeA(a_thread_buf, idx, a_thread_desc_.GetElementSpaceSize());
            ...
            static_for<0, NRepeat, 1>{}([&](auto n0) {
                ...
                static_for<0, KPerThread, KPack>{}([&](auto k) {
                    ...
                    static_for<0, KPack / 2, 1>{}([&](auto i) {
                        ...
                        b_thread_vec.template AsType<ComputeTypeB>()(2 * i) =
                            b_thread_buf[Number<b_thread_desc_.CalculateOffset(
                                make_tuple(0, 0, 0, k + 2 * i))>{}];
                        b_thread_vec.template AsType<ComputeTypeB>()(2 * i + 1) =
                            b_thread_buf[Number<b_thread_desc_.CalculateOffset(

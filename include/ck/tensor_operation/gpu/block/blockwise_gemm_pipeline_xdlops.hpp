...
struct BlockwiseGemmXdlops_pipeline_v4
{
    ...
    using Index4 = decltype(CalculateAThreadOriginDataIndex());

    __host__ __device__
    BlockwiseGemmXdlops_pipeline_v4(Index4 a_origin = CalculateAThreadOriginDataIndex(),
                                    Index4 b_origin = CalculateBThreadOriginDataIndex())

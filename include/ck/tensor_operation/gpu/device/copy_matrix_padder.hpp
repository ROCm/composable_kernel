...
CopyPadTensorDescriptor(const TensorDesc& desc, const TileLengths& tile_lengths, DoPads)
{
...
struct CopyGemmGemmPadder
{
    ...
    {
        return CopyPadTensorDescriptor(
...
template <GemmSpecialization GemmSpec,
          ...
          typename NPerTileType,
          typename KPerTileType>
struct CopyMatrixPadder : public CopyGemmPadder<GemmSpec, MPerTileType, NPerTileType, KPerTileType>
{
};

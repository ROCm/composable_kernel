#ifndef DEVICE_BNORM_FWD_WITH_REDUCE_MULTI_BLOCK_NHWC_C_HPP
#define DEVICE_BNORM_FWD_WITH_REDUCE_MULTI_BLOCK_NHWC_C_HPP

#include <iostream>
#include <sstream>
#include "device.hpp"
#include "device_bnorm_fwd.hpp"
#include "gridwise_2d_compute_mean_and_meansquare_using_reduce_multiblock.hpp"
#include "gridwise_1d_compute_inv_variance_running_mean_and_variance_fused.hpp"
#include "gridwise_1d_binary_operate.hpp"
#include "gridwise_2d_normalize_multiblock.hpp"
...
struct DeviceBatchNormFwd_Input_N_H_W_C_Output_C_With_Reduce_Multiblock : public DeviceBatchNormFwd
{
    ...
    struct Argument : public BaseArgument
    {
              ...
              epsilon_(epsilon)
        {
            ...
            while(true)
            {
                int testBlkGroupSize = (n * h * w + (K_BlockTileSize * iterations) - 1) /
    ...
    struct Invoker : public BaseInvoker
    {
        float Run(const Argument& arg, int nrepeat = 1)
        {
            ...
            const auto kernel_clean_buffer =
                kernel_buffer_set_value<BlockSize, AccDataType, ScaleBiasMeanVarGridDesc_M>;

            const auto kernel_mean_and_meansquare =
                kernel_compute_mean_and_meansquare_using_reduction_multiblock<
                    GridwiseReduceMean,
            ...
            using GridwiseNormalize = GridwiseNormalizeMultiblock_mk_input_m_scale_bias_mean_var<
                InOutDataType,
                InOutDataType,
                AccDataType,
                InOutGridDesc_M_K,
            ...
            const auto kernel_normalize = kernel_normalize_multiblock<GridwiseNormalize,
                                                                      InOutDataType,
                                                                      InOutDataType,
                                                                      AccDataType,
                                                                      InOutGridDesc_M_K,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceBatchNorm_NHWC_C_Multiblock<" << BlockSize << ",";

...
struct Device4AryElementwise : public BaseOperator
{
    ...
    using Gridwise4AryEltwise = Gridwise4AryElementwise_1D<ADataType,
                                                           BDataType,
                                                           CDataType,
                                                           DDataType,
                                                           EDataType,
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        {
            const auto kernel = kernel_4ary_elementwise_1d<Gridwise4AryEltwise,
                                                           ADataType,
                                                           BDataType,
                                                           CDataType,
                                                           DDataType,

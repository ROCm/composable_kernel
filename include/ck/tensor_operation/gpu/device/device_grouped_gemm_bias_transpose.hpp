...
struct DeviceGroupedGemmBiasTranspose : public BaseOperator
{
    ...
    MakeArgumentPointer(std::vector<const void*>& p_a,
                        ...
                        std::vector<void*>& p_c,
                        std::vector<GemmBiasTransposeDesc>& gemm_transpose_desc,
...
template <typename AElementwiseOperation,
          typename BElementwiseOperation,
          typename CElementwiseOperation>
using DeviceGroupedGemmBiasTransposePtr =
    std::unique_ptr<DeviceGroupedGemmBiasTranspose<AElementwiseOperation,

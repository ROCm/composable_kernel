                                               ...
                                               BComputeType>
{
    ...
    static constexpr IsSplitKSupported =
    ...
    struct Argument : public BaseArgument
    {
        Argument(const void* p_a,                                 // output image
            ...
            : p_a_grid_{static_cast<const ADataType*>(p_a)},
              ...
              input_right_pads_{input_right_pads} k_batch_{split_k}
        {
            // populate Ds pointer
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        float RunGemmV3(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            for(std::size_t i = 0; i < arg.a_grid_desc_ak0_m_ak1_container_.size(); i++)
            {
                ...
                index_t gdx, gdy, gdz;
                std::tie(gdx, gdy, gdz) =
                    GridwiseGemm::CalculateGridSize(GemmM, GemmN, arg.k_batch_, arg.num_group_);
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            if constexpr(isMultiD)
            {
                return RunMultiDGemm(arg, stream_config);
            }
            else
            {

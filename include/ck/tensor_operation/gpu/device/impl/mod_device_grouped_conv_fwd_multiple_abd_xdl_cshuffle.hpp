...
template <typename GridwiseGemm,
          ...
          bool isMultiA,
          bool isMultiB>
__device__ void mod_device_grouped_conv_fwd_multiple_abd_xdl_cshuffle(
    AsPointer p_as_grid,
    BsPointer p_bs_grid,
    DsPointer p_ds_grid,
            ...
            const ComputePtrOffsetOfBatch compute_ptr_offset_of_batch)
{
    ...
    mod_device_grouped_conv_fwd_multiple_abd_xdl_cshuffle<
        GridwiseGemm,
...
struct ModDeviceGroupedConvFwdMultipleABD_Xdl_CShuffle
    : public DeviceGroupedConvFwdMultipleABD<NDimSpatial,
                                             ...
                                             ComputeDataType>
{
    using DeviceOp = ModDeviceGroupedConvFwdMultipleABD_Xdl_CShuffle;

    ...
    : public BaseOperator // TODO inherit atten bwd op once API stablizes
{
    ...
    */
        ...
        Argument(
            ...
            : p_a_grid_{p_a_grid},
              ...
              vgrad_grid_desc_n_o_{DeviceOp::MakeVGradGridDescriptor_N_O(
                  b1_gs_gemm1ns_gemm1ks_lengths, b1_gs_gemm1ns_gemm1ks_strides)},
              ygrad_grid_desc_o0_m_o1_{DeviceOp::MakeYGradGridDescriptor_O0_M_O1(c_gs_ms_gemm1ns_lengths,
                                                                                 c_gs_ms_gemm1ns_strides)},
              // batch offsets
              a_grid_desc_g_m_k_{
    ...
    static bool IsSupportedArgument(const Argument& arg)
    {
        ...
        const index_t b1_gemm1n = arg.b1_grid_desc_bk0_n_bk1_.GetLength(I0) * arg.b1_grid_desc_bk0_n_bk1_.GetLength(I2);

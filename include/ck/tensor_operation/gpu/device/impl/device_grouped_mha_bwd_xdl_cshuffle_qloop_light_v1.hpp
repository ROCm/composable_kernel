...
struct DeviceGroupedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_Light_V1
    : public BaseOperator // TODO inherit atten bwd op once API stablizes
{
    ...
    using DeviceOp = DeviceGroupedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_Light_V1;
    struct ProblemDesc
    {
    ...
    */
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_Light_V1"
            << "<"
            << BlockSize << ", "
            << MPerBlock << ", "
            << NPerBlock << ", "

                                        ...
                                        OutElementwiseOperation>
{
    ...
    static auto MakeArgument(const InDataType* p_in_grid,
                             ...
                             const ck::index_t split_k)
    {
        const bool stride_ovf = tensor_exceeds_2gb<InDataType>(b_g_n_c_wis_lengths) ||
                                tensor_exceeds_2gb<WeiDataType>(e_g_k_c_xs_lengths) ||
                                tensor_exceeds_2gb<OutDataType>(a_g_n_k_wos_lengths);

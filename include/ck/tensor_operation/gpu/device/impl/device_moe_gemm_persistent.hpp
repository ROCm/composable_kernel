...
#include "ck/tensor_operation/gpu/grid/gridwise_moe_gemm_persistent.hpp"
...
struct DeviceMoeGemmPersistent : public DeviceGemmMultipleDSplitKBPreShuffle<ALayout,
                                                                   BLayout,
                                                                   DsLayout,
                                                                   CLayout,
                                                                   ADataType,
            ...
            const auto RunKernel = [&](const auto& kernel) {
                ...
                else
                {
                    ...
                    ave_time = launch_and_time_kernel(
                        stream_config, kernel, dim3(gdx, gdy, gdz), dim3(BlockSize), 0, arg, gdx);
                }
            };

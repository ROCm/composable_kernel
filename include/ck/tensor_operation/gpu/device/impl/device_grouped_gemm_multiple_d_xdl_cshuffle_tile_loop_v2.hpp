...
///
/// @tparam     GridwiseGemm0               The specific GridwiseGEMM algorithm implementation.
/// @tparam     GridwiseGemm1               The specific GridwiseGEMM algorithm implementation.
...
///                                         distribution.
/// @tparam     LocalBlock2ETileMap0        The structure providing mapping between workgroup ids,
///                                         the data tiles to process and the output tiles.
/// @tparam     LocalBlock2ETileMap1        The structure providing mapping between workgroup ids,
///                                         the data tiles to process and the output tiles.
///
template <typename GridwiseGemm0,
          typename GridwiseGemm1,
          typename GemmDesc,
          ...
          typename ELayout,
          index_t KPerBlock,
          typename OffsettedBlockToCTileMap0,
          typename LocalBlock2ETileMap0,
          typename OffsettedBlockToCTileMap1,
          typename LocalBlock2ETileMap1,
                                           ...
                                           const CDEElementwiseOperation cde_element_op)
{
    ...
    constexpr index_t shared_size0    = GridwiseGemm0::GetSharedMemoryNumberOfByte();
    constexpr index_t shared_size1    = GridwiseGemm1::GetSharedMemoryNumberOfByte();
    constexpr index_t shared_size_max = shared_size0 > shared_size1 ? shared_size0 : shared_size1;
    __shared__ uint8_t p_shared[shared_size_max];
    ...
    auto b2c_tile_map0 = OffsettedBlockToCTileMap0(LocalBlock2ETileMap0(1, 1), 1, 1);
    auto b2c_tile_map1 = OffsettedBlockToCTileMap1(LocalBlock2ETileMap1(1, 1), 1, 1);

    do
    {
        bool use_gemm_0 = true;
        ...
        if(use_gemm_0)
        {
            ...
            const bool has_main_k_block_loop = GridwiseGemm0::CalculateHasMainKBlockLoop(K_split);

            using Problem = typename GridwiseGemm0::Problem;
        ...
        else
        {
            ...
            const bool has_main_k_block_loop = GridwiseGemm1::CalculateHasMainKBlockLoop(K_split);

            using Problem = typename GridwiseGemm1::Problem;
            auto problem  = Problem(gemm_desc_ptr[group_id].M,
                                   gemm_desc_ptr[group_id].N,
                                   gemm_desc_ptr[group_id].K,
                                   gemm_desc_ptr[group_id].StrideA,
...
template <typename ALayout,
          ...
          ck::index_t MPerXDL,
          ck::index_t NPerXDL,
          ck::index_t MXdlPerWave0,
          ck::index_t MXdlPerWave1,
...
struct DeviceGroupedGemmMultipleDXdlCShuffleTileLoopV2
...
{
    using DeviceOp                      = DeviceGroupedGemmMultipleDXdlCShuffleTileLoopV2;
    static constexpr index_t NumDTensor = DsDataType::Size();

    using GridwiseGemm0 = GridwiseGemmMultiD_xdl_cshuffle_v3<
        ALayout,
        BLayout,
        DsLayout,
        ELayout,
    ...
    using GridwiseGemm1 = GridwiseGemmMultiD_xdl_cshuffle_v3<
        ALayout,
        BLayout,
        DsLayout,
        ELayout,
    ...
    using Block2ETileMap0 = BlockToCTileMap_Grouped_M00_N0_M01Adapt<8, MPerBlock0, NPerBlock>;
    using OffsettedLocalBlock2ETileMap0 = OffsettedBlockToCTileMap2<Block2ETileMap0>;
    using Block2ETileMap1 = BlockToCTileMap_Grouped_M00_N0_M01Adapt<8, MPerBlock1, NPerBlock>;
    using OffsettedLocalBlock2ETileMap1 = OffsettedBlockToCTileMap2<Block2ETileMap1>;
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        {
            const auto kernel = kernel_grouped_gemm_multiple_d_xdl<GridwiseGemm0,
                                                                   GridwiseGemm1,
                                                                   KernelArguments,
                                                                   GemmSpec,
                                                                   ADataType,
                                                                   ...
                                                                   ELayout,
                                                                   KPerBlock,
                                                                   OffsettedLocalBlock2ETileMap0,
                                                                   Block2ETileMap0,
                                                                   OffsettedLocalBlock2ETileMap1,
                                                                   Block2ETileMap1,
                                                                   AElementwiseOperation,
                                                                   BElementwiseOperation,
                                                                   CDEElementwiseOperation,
    ...
    static bool IsSupportedArgument(const Argument& arg)
    {
        ...
        for(index_t i = 0; i < arg.group_count_; ++i)
        {
            ...
            using GridArg = typename GridwiseGemm0::Argument;
            ...
            supported = supported && GridwiseGemm0::CheckValidity(gridwise_arg);
        }
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedGemmMultipleDXdlCShuffleTileLoopV2"
            << "<"

            ...
            const DxsAccElementwiseOperation dxs_out_element_op)
{
    ...
    GridwiseGemm::template Run<HasMainKBlockLoop>(
        ...
        gemm_desc_ptr[group_id].d_grid_desc_mblock_mperblock_,
                                     ...
                                     DxsAccElementwiseOperation>
{
    ...
    static auto MakeDGridDescriptor_M(index_t M)
    {
        const auto d_grid_desc_m = make_naive_tensor_descriptor_packed(make_tuple(M));
        ...
        {
            // pad M
            return transform_tensor_descriptor(d_grid_desc_m,
                                               make_tuple(make_right_pad_transform(M, PadM)),
              ...
              dxs_out_element_op_{dxs_out_element_op}
        {
            ...
            for(std::size_t i = 0; i < gemm_shapes.size(); i++)
            {
                ...
                const auto d_grid_desc_m_ =
                    DeviceGroupedGemmReduce_Xdl_CShuffle::MakeDGridDescriptor_M(M);
                                               ...
                                               grouped_gemm_block_2_ctile_map_))
                {
                    ...
                    gemm_desc_kernel_arg_.push_back(
                        GemmDescKernelArg{a_grid_desc_ak0_m_ak1_,
                                          ...
                                          static_cast<DPtrsGlobal>(p_ds[i]),
                                          BlockStart,
                                          BlockEnd});
                }
            }
    ...
    {
        using Argument = DeviceGroupedGemmReduce_Xdl_CShuffle::Argument;
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            for(std::size_t i = 0; i < arg.gemm_desc_kernel_arg_.size(); i++)
            {
                ...
                std::cout << ", arg.d_grid_desc_m_{ "
                          << arg.gemm_desc_kernel_arg_[i].d_grid_desc_m_.GetLength(I0) << "}"
                          << std::endl;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedGemmReduce_Xdl_CShuffle"
            << "<"
            << BlockSize << ", "
            << MPerBlock << ", "
            << NPerBlock << ", "

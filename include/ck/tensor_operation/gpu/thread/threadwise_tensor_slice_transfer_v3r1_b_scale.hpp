...
struct ThreadwiseTensorSliceTransfer_v3r1_b_scale
{
    ...
    __device__ constexpr ThreadwiseTensorSliceTransfer_v3r1_b_scale(
    ...
    TransferDataFromSrcThreadScratchToDstThreadScratch(Number<ThreadScratchId> thread_scratch_id)
    {
        ...
        static_ford<SliceLengths>{}([&](auto idx) {
            ...
            src_element_op_(dst_v, src_converted_thread_scratch_[idx]);

...
template <typename Gridwise4AryEltwise,
          typename ADataType,
          typename BDataType,
          typename CDataType,
          typename DDataType,
...
{
    Gridwise4AryEltwise::Run(p_a_global,
                             p_b_global,
                             p_c_global,
                             p_d_global,
                             p_e_global,
...
struct Gridwise4AryElementwise_1D
{
                               ...
                               const ElementwiseFunctor functor)
    {
        ...
        auto e_global_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
        ...
        auto e_global_write =
            ThreadwiseTensorSliceTransfer_v1r3<ComputeDataType,
                                               ...
                                               false>{
                e_grid_desc_m, thread_store_global_offset, PassThrough{}};
        ...
        do
        {
            ...
            static_for<0, MPerThread, 1>{}([&](auto m) {
                ...
                functor(e_thread_buf(Number<offset>{}),
            ...
            e_global_write.Run(thread_desc_m,
            ...
            e_global_write.MoveDstSliceWindow(e_grid_desc_m, loop_step_index);
        } while(--num_iter);
    }
};

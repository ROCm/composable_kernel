...
template <typename GridwiseGemv,
          typename FloatAB,
          typename FloatC,
...
struct GridwiseGemvDl_km_kn_mn
{
                               ...
                               integral_constant<bool, HasDoubleTailKBlockLoop>)
    {
        ...
        const auto a_grid_desc_kbatch_k0_m_k1 = GridwiseGemv::MakeAGridDescriptor_KBatch_K0_M_K1(
            karg.M, karg.MPadded, karg.K, karg.StrideA, karg.k_batch, karg.K0); //
        const auto b_grid_desc_kbatch_k0_n_k1 = GridwiseGemv::MakeBGridDescriptor_KBatch_K0_N_K1(
            karg.K, karg.NPadded, karg.N, karg.StrideB, karg.k_batch, karg.K0); //
        const auto c_grid_desc_m_n =
            GridwiseGemv::MakeCGridDescriptor_M_N(karg.M, karg.N, karg.StrideC);

        const auto a_grid_desc_kbatch_k0_m0_m1_k1 =
            GridwiseGemv::MakeAGridDescriptor_Kbatch_K0_M0_M1_K1(a_grid_desc_kbatch_k0_m_k1); //
        const auto b_grid_desc_kbatch_k0_n0_n1_k1 =
            GridwiseGemv::MakeBGridDescriptor_Kbatch_K0_N0_N1_K1(b_grid_desc_kbatch_k0_n_k1); //
        const auto c_grid_desc_m0_m10_m11_n0_n10_n11 =
            GridwiseGemv::MakeCGridDescriptor_M0_M10_M11_N0_N10_N11(c_grid_desc_m_n);
        ...
        constexpr auto c_m10_m11_n10_n11_thread_tensor_lengths =
            decltype(blockwise_gemv)::GetCThreadTensorLengths_BM0_BM1_BN0_BN1();
        ...
        if constexpr(HasMainKBlockLoop)
        {
            ...
            do
            {
                ...
                blockwise_gemv.Run(a_block_even_buf, b_thread_even_buf, c_thread_buf);
                ...
                // LDS double buffer: GEMM on current data
                blockwise_gemv.Run(a_block_odd_buf, b_thread_odd_buf, c_thread_buf);
        ...
        // output: register to global memory
        {
            ...
            const auto c_m10_m11_n10_n11_thread_origin_idx_on_block =
                blockwise_gemv.CalculateCThreadOriginOnBlock_BM0_BM1_BN0_BN1(

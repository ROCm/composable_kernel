                               ...
                               const Block2ETileMap& block_2_etile_map)
    {
        ...
        constexpr bool is_single_rate_mfma =
            (((is_same<ComputeType, half_t>::value || is_same<ComputeType, bhalf_t>::value) &&
             ...
             ((is_same<ComputeType, f8_t>::value || is_same<ComputeType, bf8_t>::value) && lcm_AK1_BK1 < 32))
                ? true
                : false;
        constexpr auto is_scale_mfma = false;
        constexpr index_t KPack = math::max(
            lcm_AK1_BK1,
            MfmaSelector<ComputeType, MPerXdl, NPerXdl, ComputeType, is_single_rate_mfma, is_scale_mfma>::

...
struct GridwiseGemmPipeline_v1_nchw_2lds;

// 1-stage prefetch
template <>
struct GridwiseGemmPipeline_v1_nchw_2lds<1, true, true>
{
    ...
    __device__ static void Run([[maybe_unused]] const AGridDescNCHW& a_grid_desc,
                               ...
                               [[maybe_unused]] ABlock1Buffer& a_block1_buf_0,
                               [[maybe_unused]] ABlock1Buffer& a_block1_buf_1,
                               [[maybe_unused]] ABlock2Buffer& a_block2_buf_0,
                               [[maybe_unused]] ABlock2Buffer& a_block2_buf_1,
                               ...
                               [[maybe_unused]] BBlockBuffer& b_block_buf_0,
                               [[maybe_unused]] BBlockBuffer& b_block_buf_1,
                               ...
                               [[maybe_unused]] index_t num_loop)
    {
        ...
        a_blockwise_global_to_lds1_copy.RunWrite(a_block1_desc_nchw_slice, a_block1_buf_0);
        b_blockwise_copy.RunWrite(b_block_desc, b_block_buf_0);

        c_thread_buf.Clear();

        //block_sunc_lds(): ?? 
        a_blockwise_lds1_to_lds2_copy.RunRead(a_block1_desc_nhowo_cyx, a_block1_buf_0);//a_block2_buf); ?? jaki bufor
        a_blockwise_lds1_to_lds2_copy.RunWrite(a_block2_desc_ak0_m_k1, a_block2_buf_0);
        ...
        if constexpr(HasMainLoop)
        {
            ...
            do
            {
                ...
                a_blockwise_global_to_lds1_copy.RunWrite(a_block1_desc_nchw_slice, a_block1_buf_1);
                b_blockwise_copy.RunWrite(b_block_desc, b_block_buf_1);

                a_blockwise_global_to_lds1_copy.MoveSrcSliceWindow(a_grid_desc, a_block_copy_step);
                b_blockwise_copy.MoveSrcSliceWindow(b_grid_desc, b_block_copy_step);

                a_blockwise_lds1_to_lds2_copy.RunRead(a_block1_desc_nhowo_cyx, a_block1_buf_1);
                a_blockwise_lds1_to_lds2_copy.RunWrite(a_block2_desc_ak0_m_k1, a_block2_buf_1);

                blockwise_gemm.Run(a_block2_buf_0, b_block_buf_0, c_thread_buf);
                ...
                // === Prefetch next tile to LDS (buffers 0 again) ===
                a_blockwise_global_to_lds1_copy.RunRead(a_grid_desc, a_grid_buf);
                b_blockwise_copy.RunRead(b_grid_desc, b_grid_buf);

                a_blockwise_lds1_to_lds2_copy.RunRead(a_block1_desc_nhowo_cyx, a_block1_buf_0);
                a_blockwise_lds1_to_lds2_copy.RunWrite(a_block2_desc_ak0_m_k1, a_block2_buf_0);

                blockwise_gemm.Run(a_block2_buf_1, b_block_buf_1, c_thread_buf);
...
constexpr auto GridwiseGemmPipeline_v1_nchw_2lds_Selector()
{

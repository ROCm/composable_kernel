...
#endif
kernel_elementwise_1d(const InGrid1dDescTuple in_grid_1d_desc_tuple,
...
struct GridwiseElementwise_1D
{
    ...
    __device__ static void Run(const InGrid1dDescTuple& in_grid_1d_desc_tuple,
                               ...
                               const Block2TileMap& block_2_tile_map,
                               const ElementwiseOperation& elementwise_op,
                               [[maybe_unused]]const UnaryOperation& unary_op,
                               [[maybe_unused]]const Scale& scale_op,
                               [[maybe_unused]]const index_t batch_size)
    {

        auto src_datas = generate_tuple(
            [&](auto I) {
        ...
        const index_t m0_block_data_idx_on_grid =
            __builtin_amdgcn_readfirstlane(block_work_idx[I0] * M0PerThread * M0PerBlock);
        const index_t m1_block_data_idx_on_grid =
            __builtin_amdgcn_readfirstlane(block_work_idx[I1] * M1PerThread * M1PerBlock);

        using ThisThreadBlock = ThisThreadBlock<BlockSize>;


        const auto thread_global_offset = make_multi_index(m0_block_data_idx_on_grid, m1_block_data_idx_on_grid);
        ...
        auto global_to_global_transfer = ThreadGroupTensorSliceTransfer_v4r1<ThisThreadBlock,
                                           ...
                                           Sequence<M0PerBlock * M0PerThread, M1PerBlock *M1PerThread>,
                                           Sequence<M0PerBlock, M1PerBlock>,
                                           ThreadClusterArrangeOrder,
                                        remove_cvref_t<decltype(src_datas.At(I0))>,
                                           remove_cvref_t<decltype(dst_datas.At(I0))>,
                                        decltype(in_grid_1d_desc_tuple.At(I0)),
                                        decltype(out_grid_1d_desc_tuple.At(I0)),
                                           SrcDimAccessOrder,
                                           DstDimAccessOrder,
                                           SrcVectorDim{},
                                           DstVectorDim{},
                                           ...
                                           OutScalarPerVectorSeq::At(I0),
                                            ...
                                            false,
                                            1> {
                                                    in_grid_1d_desc_tuple.At(I0),
                                                    thread_global_offset,
                                                    elementwise_op,
                                                    out_grid_1d_desc_tuple.At(I0),
                                                    thread_global_offset,
                                                    elementwise_op
                                           };
                                    
        global_to_global_transfer.RunRead(in_grid_1d_desc_tuple.At(I0), in_global_buf_tuple.At(I0),  I0);
        global_to_global_transfer.RunWrite(out_grid_1d_desc_tuple.At(I0), out_global_buf_tuple.At(I0), I0);
    }
};

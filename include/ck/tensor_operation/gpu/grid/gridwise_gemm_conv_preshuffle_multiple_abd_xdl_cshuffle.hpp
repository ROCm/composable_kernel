...
// struct GridwiseGemmConvPreshuffleMultipleABD_xdl_cshuffle
// {
...
//     // WSlice must be 56, and HSlice must be Y or higher. In case of Padding the LDS1 memory must
//     // be bigger
//     __host__ __device__ static constexpr auto GetABlockDescriptor_CSlice_HSlice_WSlice()
//     {
//         static constexpr auto PaddingH = PadH ? Number<X - 1>{} : I0;

//         // Slice of NCHW - initial A matrix part in LDS memory, dst of blockwise copy
//         return make_naive_tensor_descriptor(
//             make_tuple(CSlice, HSlice, WSlice + PaddingH),
//             make_tuple(HSlice * (WSlice + PaddingH), WSlice + PaddingH, I1));
//     }

//     __host__ __device__ static constexpr auto GetABlockDescriptor_CSlice_HSlice_WSlice_as_src()
//     {
//         // ask wizard Bartlomiej for some tips how to do broadcast from NCHW Slice into MPerBlock, KPerBlock
//         static constepxr auto PaddingH = PadH ? Number<X - 1>{} : I0;
...
//         constexpr auto a_block_space_size_chw_slice_aligned = math::integer_least_multiple(
...
//                             + a_block_space_size_chw_slice_aligned * sizeof(AComputeDataType) +
...
//         // N, G, C, H, W translates to M(N, G, Ho, Wo)  K(C, Y, X)
//         //

...
__global__ void
    ...
    kernel_moe_gemm(typename GridwiseGemm::Argument karg, const index_t block_cnt)
{
...
struct GridwiseMoeGemm
{
    ...
    static constexpr index_t NTileSize = NPerBlock;
    ...
    __host__ static auto CalculateGridSize(index_t k_batch)
    {
        ...
        return std::make_tuple(persistent_block_size, 1, k_batch);
    }

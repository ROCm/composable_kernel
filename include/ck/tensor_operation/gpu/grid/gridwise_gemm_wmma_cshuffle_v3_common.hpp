...
template <typename EDataType, index_t MPerBlock, index_t NPerBlock>
struct Welford
{
    ...
    __device__ Welford(EDataType* p_welford_mean_grid_,
...
struct GridwiseGemm_wmma_cshuffle_v3_base
{
    ...
    using WelfordArgument = Welford<EDataType, MPerBlock, NPerBlock>;
                                    ...
                                    WelfordArgument& epilogue_args)
    {
        ...
        auto mean_var_grid_desc_mblock_mperblock_nblock =
            epilogue_args.MakeMeanVarCountGridDescriptor_MBlock_MPerBlock_NBlock(
                epilogue_args.gemm_mean_var_grid_desc_m_nblock);

        auto mean_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            epilogue_args.p_welford_mean_grid,
            mean_var_grid_desc_mblock_mperblock_nblock.GetElementSpaceSize());

        auto var_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            epilogue_args.p_welford_var_grid,
            mean_var_grid_desc_mblock_mperblock_nblock.GetElementSpaceSize());

        auto count_grid_desc_mblock_mperblock_nblock =
            epilogue_args.MakeMeanVarCountGridDescriptor_MBlock_MPerBlock_NBlock(
                epilogue_args.gemm_count_grid_desc_m_nblock);
                               ...
                               EpilogueArgument& epilogue_args)
    {
        ...
        Epilogue<EGlobalMemoryDataOperation>(c_thread_buf,
                                             p_ds_grid,
                                             p_e_grid,
                                             p_shared,
                                             ds_grid_desc_mblock_mperblock_nblock_nperblock,

                                ...
                                const Block2ETileMap& block_2_etile_map)
    {
        ...
        constexpr bool is_single_rate_mfma =
            (((is_same<ABDataType, half_t>::value || is_same<ABDataType, bhalf_t>::value) &&
             ...
             ((is_same<ABDataType, f8_t>::value || is_same<ABDataType, bf8_t>::value) && lcm_AK1_BK1 < 32))
                ? true
                : false;
        constexpr auto is_scale_mfma = false;
        constexpr index_t KPack =
            math::max(lcm_AK1_BK1,
                      MfmaSelector<ABDataType, MPerXdl, NPerXdl, ABDataType, is_single_rate_mfma, is_scale_mfma>::

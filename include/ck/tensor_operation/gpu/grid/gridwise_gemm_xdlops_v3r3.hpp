            ...
            const Block2CTileMap block_2_ctile_map)
{
	...
	std::ignore = p_b_grid;
	std::ignore = p_c_grid;
	std::ignore = p_c0_grid;
	std::ignore = p_c1_grid;
	...
	std::ignore = c0_grid_desc_mblock_mxdlperwave_mwavemperxdl_nblock_nxdlperwave_nwavenperxdl;
	std::ignore = c1_grid_desc_mblock_mxdlperwave_mwavemperxdl_nblock_nxdlperwave_nwavenperxdl;

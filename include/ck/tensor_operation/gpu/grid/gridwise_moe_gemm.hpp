...
struct GridwiseMoeGemm
{
                               ...
                               CElementwiseOperation c_element_op)
    {
        ...
        const auto c_grid_desc_m_n = MakeCGridDescriptor_M_N<CLayout>(
            IsInputGemm ? ld_token_num * problem.TopK : ld_token_num,
            problem.MPadded,
            problem.N,
            problem.NPadded,
            problem.StrideC);
        ...
        static_for<0, AMRepeats, 1>{}([&](auto m0) {
            ...
            if constexpr (is_long_index) {
                ...
                p_a_grid += token_offset * problem.K;
            } else {
                if constexpr(!IsInputGemm)
                {
                    token_offset = token_offset * problem.TopK + (fused_token >> 24);
        ...
        // shuffle C and write out
        {
            ...
            static_for<0, num_access, 1>{}([&](auto access_id) {
                ...
                static_for<0, EMRepeats, 1>{}([&](auto m0) {
                    ...
                    if constexpr(is_long_index) {
                        if (access_id == 0)
                            p_c_grid += token_offset * problem.N;
                                    ...
                                    CElementwiseOperation c_element_op)
    {
        ...
        // shuffle C and write out
        {
            ...
            auto cde_block_copy_lds_and_global    = ThreadGroupTensorSliceTransfer_v7r3_scatter<
                ...
                decltype(tie(e_grid_desc_mblock_mperblock_nblock_nperblock)),
                CElementwiseOperation,
                Sequence<EGlobalMemoryDataOperation>, // FIXME: make Sequence
                                                                            // support arbitray type
                Sequence<1,
                         CShuffleMXdlPerWavePerShuffle * MWave * MPerXdl,
                         1,

...
struct GridwiseGemmMultiD_ABScale_xdl_cshuffle_v3
{
    ...
    struct Problem
    {
        __host__ Problem(index_t M_,
                         ...
                         index_t StrideC_,
                         index_t Scale_Block_M_,
                         index_t Scale_Block_N_,
                         index_t Scale_Block_K_,
                         index_t Scale_Stride_AM_,
                         index_t Scale_Stride_AK_,
                         index_t Scale_Stride_BN_,
                         index_t Scale_Stride_BK_,
                         index_t KBatch_)
            : M{M_},
              N{N_},
              K{K_},
              ...
              StrideDs{StrideDs_},
              StrideC{StrideC_},
              Scale_Block_M{Scale_Block_M_},
              Scale_Block_N{Scale_Block_N_},
              Scale_Block_K{Scale_Block_K_},
              Scale_Stride_AM{Scale_Stride_AM_},
              Scale_Stride_AK{Scale_Stride_AK_},
              Scale_Stride_BN{Scale_Stride_BN_},
              Scale_Stride_BK{Scale_Stride_BK_},
              KBatch{KBatch_},
        ...
        index_t Scale_Block_M;
        index_t Scale_Block_N;
        index_t Scale_Block_K;
        index_t Scale_Stride_AM;
        index_t Scale_Stride_AK;
        index_t Scale_Stride_BN;
        index_t Scale_Stride_BK;
    ...
    using BlockwiseGemmPipe = BlockwiseGemmXdlops_pipeline_v1_ab_scale<
        BlkGemmPipeSched,
        BlockSize,
        LDSTypeA,
        LDSTypeB,
                               ...
                               CElementwiseOperation c_element_op)
    {
        ...
        const auto a_scale_grid_desc_am_ak = make_naive_tensor_descriptor(
            make_tuple(problem.Scale_Block_M, problem.Scale_Block_K),
            make_tuple(problem.Scale_Stride_AM, problem.Scale_Stride_AK));
        const auto b_scale_grid_desc_bn_ak = make_naive_tensor_descriptor(
            make_tuple(problem.Scale_Block_N, problem.Scale_Block_K),
            make_tuple(problem.Scale_Stride_AM, problem.Scale_Stride_AK));
        ...
        auto a_scale_thread_copy =
            ThreadwiseTensorSliceTransfer_v2<AScaleType,
                ...
                make_multi_index(block_m_id * MPerBlock / problem.Scale_Block_M, 0));
        ...
        auto b_scale_thread_copy =
            ThreadwiseTensorSliceTransfer_v2<BScaleType,
                ...
                make_multi_index(block_n_id * NPerBlock / problem.Scale_Block_N, 0));

#if 0
        threadwise_scale_load_a.Run(a_scale_grid_desc_am_ak,
                                    a_scale_grid_buf,
                                    a_scale_thread_desc,
                                    make_tuple(I0, I0),
                                    a_scale_thread_buf);

        threadwise_scale_load_b.Run(b_scale_grid_desc_bn_ak,
                                    b_scale_grid_buf,
                                    b_scale_thread_desc,
                                    make_tuple(I0, I0),
                                    b_scale_thread_buf);
        ...
        const index_t num_k_block_per_scale = problem.Scale_Block_K / KPerBlock;

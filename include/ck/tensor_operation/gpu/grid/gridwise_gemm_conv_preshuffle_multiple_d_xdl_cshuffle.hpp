...
//         // then change blockwise gemm to use TrueKPerBlock
        ...
        auto b_blockwise_copy =
            ThreadGroupTensorSliceTransfer_v4r1<ThisThreadBlock,
                                                ...
                                                2,
                                                BBlockTransferSrcScalarPerVector, // probably 1 for now
...
//         // then change blockwise gemm to use TrueKPerBlock
        ...
        auto a_block_buf1_0 = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            static_cast<AComputeDataType*>(p_shared_0),
            a_block1_desc_cslice_hslice_wslice.GetElementSpaceSize());

        auto a_block_buf2_0 = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            static_cast<AComputeDataType*>(p_shared_0) + a_block1_space_size_aligned, 
            a_block2_desc_ak0_m_ak1.GetElementSpaceSize());

        auto b_block_buf_0 = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            static_cast<BComputeDataType*>(p_shared_0) + a_block1_space_size_aligned + a_block2_space_size_aligned,
            b_block_desc_bk0_n_bk1.GetElementSpaceSize());

        auto a_block_buf1_1 = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            static_cast<AComputeDataType*>(p_shared_1),
            a_block1_desc_cslice_hslice_wslice.GetElementSpaceSize());

        auto a_block_buf2_1 = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            static_cast<AComputeDataType*>(p_shared_1) + a_block1_space_size_aligned, 
            a_block2_desc_ak0_m_ak1.GetElementSpaceSize());

        auto b_block_buf_1 = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            static_cast<BComputeDataType*>(p_shared_1) + a_block1_space_size_aligned + a_block2_space_size_aligned,
            b_block_desc_bk0_n_bk1.GetElementSpaceSize());

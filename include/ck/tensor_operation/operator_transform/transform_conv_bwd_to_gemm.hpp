...
struct TransformConvBwdDataToGemm_v1
{
    ...
    template <typename ALayout,
              typename std::enable_if<NDimSpatial == 2 &&
                                      ...
                                      bool>::type = false>
    static auto
    MakeADescriptor_AK0_M_AK1(const std::array<index_t, NDimSpatial + 3>& out_g_n_k_wos_lengths,
                              const std::array<index_t, NDimSpatial + 3>& out_g_n_k_wos_strides,
                              const std::array<index_t, NDimSpatial + 3>& wei_g_k_c_xs_lengths,
                              const std::array<index_t, NDimSpatial + 3>& wei_g_k_c_xs_strides,
                              const std::array<index_t, NDimSpatial + 3>& in_g_n_c_wis_lengths,
                              ...
                              const std::array<index_t, NDimSpatial>& tildes)
    {
                         ...
                         Filter1x1Stride1Pad0)
        {
            ...
            return out_gemmk0_gemmm_gemmk1_grid_desc;
        }
        else
        {
            const auto GcdStrideDilationH = math::gcd(ConvStrideH, ConvDilationH);
    ...
    template <typename BLayout,
              typename std::enable_if<NDimSpatial == 2 &&
                                      ...
                                      bool>::type = false>
    static auto
    MakeBDescriptor_BK0_N_BK1(const std::array<index_t, NDimSpatial + 3>& out_g_n_k_wos_lengths,
                              const std::array<index_t, NDimSpatial + 3>& out_g_n_k_wos_strides,
                              const std::array<index_t, NDimSpatial + 3>& wei_g_k_c_xs_lengths,
                              const std::array<index_t, NDimSpatial + 3>& wei_g_k_c_xs_strides,
                              const std::array<index_t, NDimSpatial + 3>& in_g_n_c_wis_lengths,
                              ...
                              const std::array<index_t, NDimSpatial>& tildes)
    {
                         ...
                         Filter1x1Stride1Pad0)
        {
            ...
            return wei_gemmk0_gemmn_gemmk1_grid_desc;
        }
        else
        {
            const auto GcdStrideDilationH = math::gcd(ConvStrideH, ConvDilationH);
    ...
    template <typename DLayout,
              typename std::enable_if<NDimSpatial == 2 &&
                                         (is_same_v<DLayout, tensor_layout::convolution::GNHWC> ||
                                          is_same_v<DLayout, tensor_layout::convolution::G_NHW_C>),
                                      bool>::type = false>
    static auto
    MakeDDescriptor_M_N(const std::array<index_t, NDimSpatial + 3>& out_g_n_k_wos_lengths,
                        const std::array<index_t, NDimSpatial + 3>& out_g_n_k_wos_strides,
                        const std::array<index_t, NDimSpatial + 3>& wei_g_k_c_xs_lengths,
                        const std::array<index_t, NDimSpatial + 3>& wei_g_k_c_xs_strides,
                        const std::array<index_t, NDimSpatial + 3>& in_g_n_c_wis_lengths,
                        ...
                        const std::array<index_t, NDimSpatial>& tildes)
    {
                         ...
                         Filter1x1Stride1Pad0)
        {
            ...
            return bias_gemmm_gemmn_grid_desc;
        }
        else
        {
            const auto GcdStrideDilationH = math::gcd(ConvStrideH, ConvDilationH);

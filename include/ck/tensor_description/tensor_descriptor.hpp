...
{
    template <typename LowDimVisibleId>
    __host__ __device__ constexpr auto operator()(LowDimVisibleId) const
    {
        return OldTensorDescriptor::GetVisibleDimensionIds()[LowDimVisibleId{}];
    }
};

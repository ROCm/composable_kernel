...
static constexpr std::array<ck::index_t, NumDimSpatial + 3> input_lengths{N, Di, Hi, Wi, G, C};
static constexpr std::array<ck::index_t, NumDimSpatial + 3> filter_lengths{G, K, Z, Y, X, C};
static constexpr std::array<ck::index_t, NumDimSpatial + 3> output_lengths{N, Do, Ho, Wo, G, K};

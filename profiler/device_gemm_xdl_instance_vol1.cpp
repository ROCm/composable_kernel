...
using device_gemm_xdl_instance_f16_f16_f16_mk_nk_mn = std::tuple<
    ...
    ck::tensor_operation::device::DeviceGemmXdl<  F16,   F16,   F16,     F32,     Row,      Col,    Row,   256,   128,   256,     4,  8,   32,   32,    2,    4,           S<1, 2, 8>,            S<4, 64, 1>,           S<1, 0, 2>,     S<1, 0, 2>,            2,               8,              8,      S<1, 4, 8>,     S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,           2,              8,              8,               7,               1,      true,      true>,
    ck::tensor_operation::device::DeviceGemmXdl<  F16,   F16,   F16,     F32,     Row,      Col,    Row,   128,   128,   128,     4,  8,   32,   32,    4,    2,           S<1, 4, 8>,            S<4, 32, 1>,           S<1, 0, 2>,     S<1, 0, 2>,            2,               8,              8,      S<1, 4, 8>,     S<4, 32, 1>,      S<1, 0, 2>,      S<1, 0, 2>,           2,              8,              8,               7,               1,      true,      true>,
    ...
    ck::tensor_operation::device::DeviceGemmXdl<  F16,   F16,   F16,     F32,     Row,      Col,    Row,   128,   128,    64,     4,  8,   32,   32,    2,    2,           S<1, 4, 8>,            S<4, 32, 1>,           S<1, 0, 2>,     S<1, 0, 2>,            2,               8,              8,      S<1, 2, 8>,     S<4, 32, 1>,      S<1, 0, 2>,      S<1, 0, 2>,           2,              8,              8,               7,               1,      true,      true>,
    ...
    ck::tensor_operation::device::DeviceGemmXdl<  F16,   F16,   F16,     F32,     Row,      Col,    Row,   256,   128,    64,     4,  8,   32,   32,    2,    1,           S<1, 2, 8>,            S<4, 64, 1>,           S<1, 0, 2>,     S<1, 0, 2>,            2,               8,              8,      S<1, 1, 8>,     S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,           2,              8,              8,               7,               1,      true,      true>,
    ck::tensor_operation::device::DeviceGemmXdl<  F16,   F16,   F16,     F32,     Row,      Col,    Row,   256,    64,   128,     4,  8,   32,   32,    1,    2,           S<1, 1, 8>,            S<4, 64, 1>,           S<1, 0, 2>,     S<1, 0, 2>,            2,               8,              8,      S<1, 2, 8>,     S<4, 64, 1>,      S<1, 0, 2>,      S<1, 0, 2>,           2,              8,              8,               7,               1,      true,      true>
    // clang-format on
    >;

void add_device_gemm_xdl_instance_f16_f16_f16_mk_nk_mn(

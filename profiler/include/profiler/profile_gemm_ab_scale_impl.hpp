                                ...
                                uint64_t rotating = 0)
{
    ...
    ck::profiler::validate_gemm_stride<ALayout>(M, K, StrideA, "StrideA");
    ck::profiler::validate_gemm_stride<BLayout>(K, N, StrideB, "StrideB");
    ck::profiler::validate_gemm_stride<BLayout>(M, N, StrideE, "StrideE");

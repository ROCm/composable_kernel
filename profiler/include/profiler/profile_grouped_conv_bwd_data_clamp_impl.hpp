...
#include "ck/library/tensor_operation_instance/gpu/grouped_convolution_backward_data_clamp.hpp"
...
template <ck::index_t NDimSpatial,
          ...
          typename InDataType>
bool profile_grouped_conv_bwd_data_clamp_impl(int do_verification,
                                        int init_method,
                                        bool do_log,
                                        bool time_kernel,
                                        ...
                                        ck::index_t split_k = 1)
{
    ...
    using InElementOp  = ck::tensor_operation::element_wise::Clamp;
    ...
    const auto in_element_op  = InElementOp{floor, ceil};
    ...
    std::cout << "op_ptrs" << op_ptrs.size() << std::endl;

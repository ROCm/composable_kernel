                                                      ...
                                                      int num_dim_spatial = 2)
{
    ...
    {
    case 3: {
        return ck::utils::conv::GetHostTensorDescriptor(dims, InLayout{});
    }
    case 2: {
        return ck::utils::conv::GetHostTensorDescriptor(dims, InLayout{});
    }
                                                        ...
                                                        int num_dim_spatial = 2)
{
    ...
    {
    case 3: {
        return ck::utils::conv::GetHostTensorDescriptor(dims, WeiLayout{});
    }
    case 2: {
        return ck::utils::conv::GetHostTensorDescriptor(dims, WeiLayout{});
    }
                                                      ...
                                                      int num_dim_spatial = 2)
{
    ...
    {
    case 3: {
        return ck::utils::conv::GetHostTensorDescriptor(dims, OutLayout{});
    }
    case 2: {
        return ck::utils::conv::GetHostTensorDescriptor(dims, OutLayout{});
    }
                                  ...
                                  const std::vector<ck::index_t>& input_right_pads)
{
    ...
    for(auto& conv_ptr : conv_ptrs)
    {
        ...
        if(conv_ptr->IsSupportedArgument(argument_ptr.get()))
        {
            ...
            std::size_t flop =
                ck::utils::conv::GetFlops(N, C, K, filter_spatial_lengths, output_spatial_lengths);

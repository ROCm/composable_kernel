...
using device_gemm_xdl_instance_f16_f16_f16_mk_nk_mn_vol2 = std::tuple<
    // clang-format off
    ...
    ck::tensor_operation::device::DeviceGemmXdl<  F16,   F16,   F16,     F32,     Row,      Col,    Row,   128,    64,   128,     4,  8,   32,   32,    2,    2,           S<1, 2, 8>,            S<4, 32, 1>,           S<1, 0, 2>,     S<1, 0, 2>,            2,               8,              8,      S<1, 4, 8>,     S<4, 32, 1>,      S<1, 0, 2>,      S<1, 0, 2>,              2,              8,              8,               7,               1,      true,      true>
    // clang-format on
    >;
...
{
    using DeviceGemms =
        device_gemm_xdl_instance::device_gemm_xdl_instance_f16_f16_f16_mk_nk_mn_vol2;

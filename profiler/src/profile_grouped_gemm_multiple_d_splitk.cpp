...
#include "profiler/profile_grouped_gemm_multiple_d_splitk_impl.hpp"
...
#define OP_NAME "grouped_gemm_multid_splitk"
...
int profile_grouped_gemm_multiple_d_splitk(int argc, char* argv[])
{
    if(argc < 14)
    {
        std::cout
...
REGISTER_PROFILER_OPERATION(OP_NAME, OP_DESC, profile_grouped_gemm_multiple_d_splitk);

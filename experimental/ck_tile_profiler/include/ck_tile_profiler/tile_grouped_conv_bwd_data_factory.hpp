...
// void add_grouped_conv2d_bwd_weight_f16_instances(std::vector<std::unique_ptr<DeviceOp2DF16>>&
// instances);
void add_grouped_conv2d_bwd_data_bf16_instances(
    std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances);
void add_grouped_conv2d_bwd_data_bf16_instances_2(
    std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances);
void add_grouped_conv2d_bwd_data_bf16_instances_3(
    std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances);
void add_grouped_conv2d_bwd_data_bf16_instances_4(
    std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances);
void add_grouped_conv2d_bwd_data_bf16_instances_5(
    std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances);
void add_grouped_conv2d_bwd_data_bf16_instances_6(
    std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances);
void add_grouped_conv2d_bwd_data_bf16_instances_7(
    std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances);

// void
// add_grouped_conv2d_bwd_weight_bf16_instances_opt(std::vector<std::unique_ptr<DeviceOp2DBF16>>&
// instances);
...
struct DeviceOperationInstanceFactory<GroupedConvolutionBackwardDataBaseInvoker<NumDimSpatial,
                                                                                InLayout,
                                                                                WeiLayout,
                                                                                OutLayout,
                                                                                InDataType,

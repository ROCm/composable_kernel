...
using DeviceOp2DF16 =
    GroupedConvolutionBackwardWeightBaseInvoker<2,
                                                NHWGC,
                                                GKYXC,
                                                NHWGK,
                                                ck_tile::half_t,
...
void add_grouped_conv2d_bwd_weight_bf16_instances_opt(
    std::vector<std::unique_ptr<DeviceOp2DBF16>>& instances);
...
struct DeviceOperationInstanceFactory<GroupedConvolutionBackwardWeightBaseInvoker<NumDimSpatial,
                                                                                  InLayout,
                                                                                  WeiLayout,
                                                                                  OutLayout,
                                                                                  InDataType,

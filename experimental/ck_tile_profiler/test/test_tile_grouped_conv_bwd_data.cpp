...
#include "ck_tile_profiler/tile_grouped_conv_bwd_data_invoker.hpp"
...
bool profile_grouped_conv_bwd_data_impl(const ck_tile::conv::ConvParam& conv_param,
                                        const int split_k)
{
    ...
    const auto op =
        ck_tile::ops::GroupedConvolutionBackwardDataInvoker<NDimSpatial,
                                                            InLayout,
                                                            WeiLayout,
                                                            OutLayout,
                                                            InDataType,
    ...
    if(op.IsSupportedArgument(args))
    {
        ...
        return ck_tile::check_err(input,
                                  input_gpu_ref,
...
TEST(TileGroupedConv, BackwardData)
{
    ...
    {
        bool passed = profile_grouped_conv_bwd_data_impl<
            2,                                          /*NDimSpatial*/
        ...
        passed &= profile_grouped_conv_bwd_data_impl<
            2,                                          /*NDimSpatial*/
            ck_tile::tensor_layout::convolution::NHWGC, /*InLayout*/
            ck_tile::tensor_layout::convolution::GKYXC, /*WeiLayout*/
            ck_tile::tensor_layout::convolution::NHWGK, /*OutLayout*/

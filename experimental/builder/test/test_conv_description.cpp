...
{
    ckb::test::ThreadBlock thread_block{
        .block_size = 256,
        .tile_size = {.m = 256, .n = 256, .k = 32}
    };
    
    ckb::test::GridwiseXdlGemm gridwise_gemm{
        .ak1 = 8,
        .bk1 = 8,
        .m_per_xdl = 16,
        .n_per_xdl = 16,
    ...
    ckb::test::BlockTransferABC block_transfer{
        ...
        .thread_cluster_dims_c = {.m_block = 1, .m_wave_per_xdl = 32, .n_block = 1, .n_wave_per_xdl = 8},
        .lds_transfer_a = {
            .src_vector_dim = 2,
    ...
    ckb::test::BlockGemm block_gemm{
        .pipeline_version = ckb::PipelineVersion::V4,

...
// Use the first instance from device_grouped_conv_bwd_weight_two_stage_nhwgc_xdl_c_shuffle_f16_generic_instances
...
std::string expected_str = "DeviceGroupedConvBwdWeightTwoStage_Xdl_CShuffle"
                           "<2"             // NDimSpatial
                           ",GNHWC"         // InLayout
                           ",GKYXC"         // WeiLayout
                           ",GNHWK"         // OutLayout

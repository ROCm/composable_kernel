...
{
    static constexpr auto sig = ConvSignature<>{
        .spatial_dim = 1,
        .direction = FORWARD,
...
TEST(ConvTensorLayoutsWithAuxiliary, Conv2DWithSingleBiasG_K)
{
    ...
    static constexpr auto sig = ConvSignature<
        ...
        .weight = {.config = {.layout = TensorLayout::GKYXC}},
        .output = {
            .config = {.layout = TensorLayout::NGKHW},
            .operation = OutputOp{.elementwise_operation = ElementwiseOperation::SCALE}
        }
    };
...
{
    using OutputOp = TensorOperation<
        TensorConfig{.layout = TensorLayout::G_K_strided},
    ...
    static constexpr auto sig = ConvSignature<
        ...
        .weight = {.config = {.layout = TensorLayout::GKYXC}},
        .output = {
            .config = {.layout = TensorLayout::GNHWK},
            .operation = OutputOp{.elementwise_operation = ElementwiseOperation::SCALEADD_SCALEADD_RELU}
        }
    };
...
TEST(ConvTensorLayoutsWithAuxiliary, Conv1DWithBias)
{
    ...
    static constexpr auto sig = ConvSignature<
        ...
        .weight = {.config = {.layout = TensorLayout::GKXC}},
        .output = {
            .config = {.layout = TensorLayout::NWGK},
            .operation = OutputOp{.elementwise_operation = ElementwiseOperation::SCALE}
        }
    };
...
TEST(ConvTensorLayoutsWithAuxiliary, Conv3DWithBias)
{
    ...
    static constexpr auto sig = ConvSignature<
        ...
        .weight = {.config = {.layout = TensorLayout::GKZYXC}},
        .output = {
            .config = {.layout = TensorLayout::NDHWGK},
            .operation = OutputOp{.elementwise_operation = ElementwiseOperation::BIAS_BNORM_CLAMP}
        }
    };

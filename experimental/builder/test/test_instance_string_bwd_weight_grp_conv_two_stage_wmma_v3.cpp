...
// Use the first instance from device_grouped_conv_bwd_weight_two_stage_nhwgc_wmma_c_shuffle_f16_instances
...
std::string expected_str = "DeviceGroupedConvBwdWeightTwoStage_Wmma_CShuffleV3"
                           "<2"             // NDimSpatial
                           ",GNHWC"         // InLayout
                           ",GKYXC"         // WeiLayout
                           ",GNHWK"         // OutLayout

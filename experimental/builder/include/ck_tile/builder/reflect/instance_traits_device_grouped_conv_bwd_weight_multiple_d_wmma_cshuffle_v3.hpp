...
struct InstanceTraits<ck::tensor_operation::device::DeviceGroupedConvBwdWeightMultipleD_Wmma_CShuffleV3<
    NDimSpatial,
    InLayout_,
    WeiLayout_,
    OutLayout_,
    ...
    ComputeTypeB_>>
{
    ...
    using ABlockTransferThreadClusterLengths_AK0_M_AK1 = ABlockTransferThreadClusterLengths_AK0_M_AK1_;
